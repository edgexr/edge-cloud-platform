...
var ConfigComments = map[string]string{
	...
	"logshowapis":                   `Log most show/GET APIs for debugging`,
	"logallshowapis":                `Log all show/GET APIs, including noisy ones you likely don't need to see, like Login, audit/event/terms show, ShowAlerts, etc.`,
	"logshowurl":                    `Log specific API url (may be substring of entire URL)`,
	"corsenable":                    `Enable CORS (cross origin resource sharing)`,
...
var AllDataComments = map[string]string{
	...
	"alertreceivers:#.appinstkey":                     `AppInstKey spec for alerts (includes CloudletKey)`,
	"alertreceivers:#.appkey":                         `AppKey spec for alerts`,
	"alertreceivers:#.clusterkey":                     `ClusterKey spec for alerts`,
...
var RegionClientApiUsageMetricsComments = map[string]string{
	...
	"metricscommon.limit":      `Display the last X metrics`,
	"region":                   `Region name`,
	"appkey":                   `Application key for app usage`,
	"cloudletkey":              `Cloudlet key for cloudlet usage`,
...
var RegionClientAppUsageMetricsComments = map[string]string{
	...
	"metricscommon.limit":      `Display the last X metrics`,
	"region":                   `Region name`,
	"appinstkey":               `Application instance key for appinst usage (also includes CloudletKey for cloudlet usage)`,
	"appkey":                   `App key for app usage`,
	"selector":                 `Comma separated list of metrics to view. Available metrics: utilization, network, ipusage`,
...
var AlertReceiverComments = map[string]string{
	...
	"appinstkey":              `AppInstKey spec for alerts (includes CloudletKey)`,
	"appkey":                  `AppKey spec for alerts`,
	"clusterkey":              `ClusterKey spec for alerts`,
}
