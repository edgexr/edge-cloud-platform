...
var FederationProviderComments = map[string]string{
	...
	"myinfo.federationid":           `Globally unique string used to indentify a federation with partner federation`,
	...
	"myinfo.fixednetworkids":        `Fixed linke network ids`,
	...
	"partnerinfo.federationid":      `Globally unique string used to indentify a federation with partner federation`,
	...
	"partnerinfo.fixednetworkids":   `Fixed linke network ids`,
...
var FederationProviderInfoComments = map[string]string{
	...
	"clientkey":  `Client Key for Oauth. Save this, as it the system cannot retreive it.`,
...
var FederatorComments = map[string]string{
	...
	"fixednetworkids":   `Fixed linke network ids`,
