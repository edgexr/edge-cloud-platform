...
type ClusterInst struct {
	...
	// Kubernetes version of cluster if applicable, semver format, i.e. v1.34.0
	...
	DisableDynamicAppinstPlacement bool `protobuf:"varint,49,opt,name=disable_dynamic_appinst_placement,json=disableDynamicAppinstPlacement,proto3" json:"disable_dynamic_appinst_placement,omitempty"`
	// Cloudlet managed cluster ID, if cluster based on cloudlet managed cluster
	CloudletManagedClusterId string `protobuf:"bytes,50,opt,name=cloudlet_managed_cluster_id,json=cloudletManagedClusterId,proto3" json:"cloudlet_managed_cluster_id,omitempty"`
	// Cloudlet managed cluster name, if cluster based on cloudlet managed cluster
	CloudletManagedClusterName string `protobuf:"bytes,51,opt,name=cloudlet_managed_cluster_name,json=cloudletManagedClusterName,proto3" json:"cloudlet_managed_cluster_name,omitempty"`
	// Restricted namespace for the default cluster on a single kubernetes cluster cloudlet
	SingleKubernetesNamespace string `protobuf:"bytes,52,opt,name=single_kubernetes_namespace,json=singleKubernetesNamespace,proto3" json:"single_kubernetes_namespace,omitempty"`
	// Prevents cleanup of resources on timeout within CRM, used for diagnostic purposes
	SkipCrmCleanupOnTimeout bool `protobuf:"varint,53,opt,name=skip_crm_cleanup_on_timeout,json=skipCrmCleanupOnTimeout,proto3" json:"skip_crm_cleanup_on_timeout,omitempty"`
...
type ClusterResourceUsage struct {
	...
	ReservedBy string `protobuf:"bytes,10,opt,name=ReservedBy,proto3" json:"ReservedBy,omitempty"`
}
...
type ClusterCredentialsRequest struct {
	...
	Config *ClusterCredentialsConfig `protobuf:"bytes,2,opt,name=config,proto3" json:"config,omitempty"`
}

func (m *ClusterCredentialsRequest) Reset()         { *m = ClusterCredentialsRequest{} }
func (m *ClusterCredentialsRequest) String() string { return proto.CompactTextString(m) }
func (*ClusterCredentialsRequest) ProtoMessage()    {}
func (*ClusterCredentialsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d2ba73d39f00460, []int{5}
}
func (m *ClusterCredentialsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ClusterCredentialsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ClusterCredentialsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ClusterCredentialsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClusterCredentialsRequest.Merge(m, src)
}
func (m *ClusterCredentialsRequest) XXX_Size() int {
	return m.Size()
}
func (m *ClusterCredentialsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ClusterCredentialsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ClusterCredentialsRequest proto.InternalMessageInfo

// ClusterCredentaislConfig is currently empty, but in the future
// may specify the scope and permissions of the credentials.
type ClusterCredentialsConfig struct {
}

func (m *ClusterCredentialsConfig) Reset()         { *m = ClusterCredentialsConfig{} }
func (m *ClusterCredentialsConfig) String() string { return proto.CompactTextString(m) }
func (*ClusterCredentialsConfig) ProtoMessage()    {}
func (*ClusterCredentialsConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d2ba73d39f00460, []int{6}
}
func (m *ClusterCredentialsConfig) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ClusterCredentialsConfig) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ClusterCredentialsConfig.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ClusterCredentialsConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClusterCredentialsConfig.Merge(m, src)
}
func (m *ClusterCredentialsConfig) XXX_Size() int {
	return m.Size()
}
func (m *ClusterCredentialsConfig) XXX_DiscardUnknown() {
	xxx_messageInfo_ClusterCredentialsConfig.DiscardUnknown(m)
}

var xxx_messageInfo_ClusterCredentialsConfig proto.InternalMessageInfo

// CloudletManagedClusterInfo provides information from the Cloudlet Resource Manager about the state of the managed cluster on the Cloudlet
type CloudletManagedClusterInfo struct {
	...
	NodePools []*NodePool `protobuf:"bytes,2,rep,name=node_pools,json=nodePools,proto3" json:"node_pools,omitempty"`
}

func (m *CloudletManagedClusterInfo) Reset()         { *m = CloudletManagedClusterInfo{} }
func (m *CloudletManagedClusterInfo) String() string { return proto.CompactTextString(m) }
func (*CloudletManagedClusterInfo) ProtoMessage()    {}
func (*CloudletManagedClusterInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d2ba73d39f00460, []int{7}
}
func (m *CloudletManagedClusterInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CloudletManagedClusterInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CloudletManagedClusterInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CloudletManagedClusterInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CloudletManagedClusterInfo.Merge(m, src)
}
func (m *CloudletManagedClusterInfo) XXX_Size() int {
	return m.Size()
}
func (m *CloudletManagedClusterInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_CloudletManagedClusterInfo.DiscardUnknown(m)
}

var xxx_messageInfo_CloudletManagedClusterInfo proto.InternalMessageInfo
...
type ClusterInstInfo struct {
	...
	// cloudlet managed cluster info
	CloudletManagedClusterInfo *CloudletManagedClusterInfo `protobuf:"bytes,8,opt,name=cloudlet_managed_cluster_info,json=cloudletManagedClusterInfo,proto3" json:"cloudlet_managed_cluster_info,omitempty"`
	// Annotations added by the implementing infrastructure
...
func (*ClusterInstInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d2ba73d39f00460, []int{8}
}
...
func init() {
	...
	proto.RegisterType((*ClusterCredentialsRequest)(nil), "edgeproto.ClusterCredentialsRequest")
	proto.RegisterType((*ClusterCredentialsConfig)(nil), "edgeproto.ClusterCredentialsConfig")
	proto.RegisterType((*CloudletManagedClusterInfo)(nil), "edgeproto.CloudletManagedClusterInfo")
...
var fileDescriptor_2d2ba73d39f00460 = []byte{
	...
	,
}
...
type ClusterInstApiClient interface {
	...
	// Get credentials to access the cluster. Currently this only supports Kubernetes clusters, and returns the kubeconfig contents.
	GetClusterCredentials(ctx context.Context, in *ClusterCredentialsRequest, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *clusterInstApiClient) GetClusterCredentials(ctx context.Context, in *ClusterCredentialsRequest, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/edgeproto.ClusterInstApi/GetClusterCredentials", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ClusterInstApiServer interface {
	...
	// Get credentials to access the cluster. Currently this only supports Kubernetes clusters, and returns the kubeconfig contents.
	GetClusterCredentials(context.Context, *ClusterCredentialsRequest) (*Result, error)
}
...
func (*UnimplementedClusterInstApiServer) GetClusterCredentials(ctx context.Context, req *ClusterCredentialsRequest) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetClusterCredentials not implemented")
}
...
func _ClusterInstApi_GetClusterCredentials_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClusterCredentialsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClusterInstApiServer).GetClusterCredentials(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/edgeproto.ClusterInstApi/GetClusterCredentials",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterInstApiServer).GetClusterCredentials(ctx, req.(*ClusterCredentialsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClusterInstApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ClusterInstApi_GetClusterCredentials_Handler,
		},
	},
...
func (m *ClusterInst) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SingleKubernetesNamespace) > 0 {
		...
		i = encodeVarintClusterinst(dAtA, i, uint64(len(m.SingleKubernetesNamespace)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xa2
	}
	if len(m.CloudletManagedClusterName) > 0 {
		i -= len(m.CloudletManagedClusterName)
		copy(dAtA[i:], m.CloudletManagedClusterName)
		i = encodeVarintClusterinst(dAtA, i, uint64(len(m.CloudletManagedClusterName)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0x9a
	}
	if len(m.CloudletManagedClusterId) > 0 {
		i -= len(m.CloudletManagedClusterId)
		copy(dAtA[i:], m.CloudletManagedClusterId)
		i = encodeVarintClusterinst(dAtA, i, uint64(len(m.CloudletManagedClusterId)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0x92
	}
	if m.DisableDynamicAppinstPlacement {
		i--
		if m.DisableDynamicAppinstPlacement {
			dAtA[i] = 1
		} else {
...
func (m *ClusterCredentialsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ClusterCredentialsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ClusterCredentialsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ClusterCredentialsConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ClusterCredentialsConfig) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ClusterCredentialsConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CloudletManagedClusterInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CloudletManagedClusterInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CloudletManagedClusterInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ClusterInstInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CloudletManagedClusterInfo != nil {
		{
			size, err := m.CloudletManagedClusterInfo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ClusterInst) Matches(o *ClusterInst, fopts ...MatchOpt) bool {
	...
	if !opts.Filter || o.DisableDynamicAppinstPlacement != false {
		if o.DisableDynamicAppinstPlacement != m.DisableDynamicAppinstPlacement {
			return false
		}
	}
	if !opts.IgnoreBackend {
		if !opts.Filter || o.CloudletManagedClusterId != "" {
			if o.CloudletManagedClusterId != m.CloudletManagedClusterId {
				return false
			}
		}
	}
	if !opts.IgnoreBackend {
		if !opts.Filter || o.CloudletManagedClusterName != "" {
			if o.CloudletManagedClusterName != m.CloudletManagedClusterName {
				return false
			}
		}
	}
	...
	if !opts.IgnoreBackend {
		if !opts.Filter || o.SkipCrmCleanupOnTimeout != false {
			if o.SkipCrmCleanupOnTimeout != m.SkipCrmCleanupOnTimeout {
				return false
			}
		}
	}
...
const ClusterInstFieldDisableDynamicAppinstPlacement = "49"
const ClusterInstFieldCloudletManagedClusterId = "50"
const ClusterInstFieldCloudletManagedClusterName = "51"
const ClusterInstFieldSingleKubernetesNamespace = "52"
const ClusterInstFieldSkipCrmCleanupOnTimeout = "53"
...
var ClusterInstAllFields = []string{
	...
	ClusterInstFieldNodeResourcesOptResMap,
	...
	ClusterInstFieldNodeResourcesGpus,
	ClusterInstFieldNodeResources,
	...
	ClusterInstFieldNodePoolsNodeResourcesOptResMap,
	...
	ClusterInstFieldNodePoolsNodeResourcesGpus,
	ClusterInstFieldNodePoolsNodeResources,
	ClusterInstFieldNodePoolsScalable,
	ClusterInstFieldNodePoolsControlPlane,
	ClusterInstFieldNodePools,
	ClusterInstFieldInfraAnnotationsKey,
	ClusterInstFieldInfraAnnotationsValue,
	ClusterInstFieldInfraAnnotations,
	ClusterInstFieldKubernetesVersion,
	ClusterInstFieldDisableDynamicAppinstPlacement,
	ClusterInstFieldCloudletManagedClusterId,
	ClusterInstFieldCloudletManagedClusterName,
	ClusterInstFieldSingleKubernetesNamespace,
	ClusterInstFieldSkipCrmCleanupOnTimeout,
	ClusterInstFieldTagsKey,
	ClusterInstFieldTagsValue,
	ClusterInstFieldTags,
}
...
var ClusterInstAllFieldsMap = NewFieldMap(map[string]struct{}{
	...
	ClusterInstFieldCloudletKey:                              struct{}{},
	...
	ClusterInstFieldNodeResourcesOptResMap:                   struct{}{},
	...
	ClusterInstFieldNodeResourcesGpus:                        struct{}{},
	ClusterInstFieldNodeResources:                            struct{}{},
	...
	ClusterInstFieldDisableDynamicAppinstPlacement:           struct{}{},
	ClusterInstFieldCloudletManagedClusterId:                 struct{}{},
	ClusterInstFieldCloudletManagedClusterName:               struct{}{},
	ClusterInstFieldSingleKubernetesNamespace:                struct{}{},
	ClusterInstFieldSkipCrmCleanupOnTimeout:                  struct{}{},
...
var ClusterInstAllFieldsStringMap = map[string]string{
	...
	ClusterInstFieldKey:                                      "Key",
	ClusterInstFieldFlavorName:                               "Flavor Name",
	ClusterInstFieldFlavor:                                   "Flavor",
	...
	ClusterInstFieldResourcesVmsContainers:                   "Resources Vms Containers",
	ClusterInstFieldResourcesVms:                             "Resources Vms",
	ClusterInstFieldResources:                                "Resources",
	ClusterInstFieldCreatedAtSeconds:                         "Created At Seconds",
	ClusterInstFieldCreatedAtNanos:                           "Created At Nanos",
	ClusterInstFieldCreatedAt:                                "Created At",
	ClusterInstFieldUpdatedAtSeconds:                         "Updated At Seconds",
	ClusterInstFieldUpdatedAtNanos:                           "Updated At Nanos",
	ClusterInstFieldUpdatedAt:                                "Updated At",
	...
	ClusterInstFieldReservationEndedAt:                       "Reservation Ended At",
	...
	ClusterInstFieldZoneKey:                                  "Zone Key",
	...
	ClusterInstFieldNodeResourcesOptResMap:                   "Node Resources Opt Res Map",
	...
	ClusterInstFieldNodeResourcesGpus:                        "Node Resources Gpus",
	ClusterInstFieldNodeResources:                            "Node Resources",
	...
	ClusterInstFieldNodePoolsNodeResourcesOptResMap:          "Node Pools Node Resources Opt Res Map",
	...
	ClusterInstFieldNodePoolsNodeResourcesGpus:               "Node Pools Node Resources Gpus",
	ClusterInstFieldNodePoolsNodeResources:                   "Node Pools Node Resources",
	ClusterInstFieldNodePoolsScalable:                        "Node Pools Scalable",
	ClusterInstFieldNodePoolsControlPlane:                    "Node Pools Control Plane",
	ClusterInstFieldNodePools:                                "Node Pools",
	ClusterInstFieldInfraAnnotationsKey:                      "Infra Annotations Key",
	ClusterInstFieldInfraAnnotationsValue:                    "Infra Annotations Value",
	ClusterInstFieldInfraAnnotations:                         "Infra Annotations",
	ClusterInstFieldKubernetesVersion:                        "Kubernetes Version",
	ClusterInstFieldDisableDynamicAppinstPlacement:           "Disable Dynamic Appinst Placement",
	ClusterInstFieldCloudletManagedClusterId:                 "Cloudlet Managed Cluster Id",
	ClusterInstFieldCloudletManagedClusterName:               "Cloudlet Managed Cluster Name",
	ClusterInstFieldSingleKubernetesNamespace:                "Single Kubernetes Namespace",
	ClusterInstFieldSkipCrmCleanupOnTimeout:                  "Skip Crm Cleanup On Timeout",
	ClusterInstFieldTagsKey:                                  "Tags Key",
	ClusterInstFieldTagsValue:                                "Tags Value",
	ClusterInstFieldTags:                                     "Tags",
}
...
var ClusterInstBackendFieldsMap = map[string]struct{}{
	ClusterInstFieldFlavorName:                               struct{}{},
	ClusterInstFieldFlavor:                                   struct{}{},
	ClusterInstFieldState:                                    struct{}{},
	ClusterInstFieldErrors:                                   struct{}{},
...
var ClusterInstNoConfigFieldsMap = map[string]struct{}{
	ClusterInstFieldState:                             struct{}{},
	ClusterInstFieldErrors:                            struct{}{},
	ClusterInstFieldAllocatedIp:                       struct{}{},
	ClusterInstFieldLiveness:                          struct{}{},
...
func (m *ClusterInst) DiffFields(o *ClusterInst, fields *FieldMap) {
	...
	if m.DisableDynamicAppinstPlacement != o.DisableDynamicAppinstPlacement {
		fields.Set(ClusterInstFieldDisableDynamicAppinstPlacement)
	}
	if m.CloudletManagedClusterId != o.CloudletManagedClusterId {
		fields.Set(ClusterInstFieldCloudletManagedClusterId)
	}
	if m.CloudletManagedClusterName != o.CloudletManagedClusterName {
		fields.Set(ClusterInstFieldCloudletManagedClusterName)
	}
	if m.SingleKubernetesNamespace != o.SingleKubernetesNamespace {
		fields.Set(ClusterInstFieldSingleKubernetesNamespace)
	}
	if m.SkipCrmCleanupOnTimeout != o.SkipCrmCleanupOnTimeout {
		fields.Set(ClusterInstFieldSkipCrmCleanupOnTimeout)
	}
...
func (m *ClusterInst) CopyInFields(src *ClusterInst) int {
	...
	if fmap.Has("49") {
		if m.DisableDynamicAppinstPlacement != src.DisableDynamicAppinstPlacement {
			m.DisableDynamicAppinstPlacement = src.DisableDynamicAppinstPlacement
			changed++
		}
	}
	if fmap.Has("50") {
		if m.CloudletManagedClusterId != src.CloudletManagedClusterId {
			m.CloudletManagedClusterId = src.CloudletManagedClusterId
			changed++
		}
	}
	if fmap.Has("51") {
		if m.CloudletManagedClusterName != src.CloudletManagedClusterName {
			m.CloudletManagedClusterName = src.CloudletManagedClusterName
			changed++
		}
	}
	if fmap.Has("52") {
	...
	if fmap.Has("53") {
		if m.SkipCrmCleanupOnTimeout != src.SkipCrmCleanupOnTimeout {
			m.SkipCrmCleanupOnTimeout = src.SkipCrmCleanupOnTimeout
			changed++
		}
	}
...
func (m *ClusterCredentialsRequest) Clone() *ClusterCredentialsRequest {
	cp := &ClusterCredentialsRequest{}
	cp.DeepCopyIn(m)
	return cp
}

func (m *ClusterCredentialsRequest) CopyInFields(src *ClusterCredentialsRequest) int {
	changed := 0
	if m.Key.Name != src.Key.Name {
		m.Key.Name = src.Key.Name
		changed++
	...
	if src.Config != nil {
		if m.Config == nil {
			m.Config = &ClusterCredentialsConfig{}
		}
...
func (m *ClusterCredentialsRequest) DeepCopyIn(src *ClusterCredentialsRequest) {
	m.Key.DeepCopyIn(&src.Key)
	if src.Config != nil {
		var tmp_Config ClusterCredentialsConfig
		tmp_Config.DeepCopyIn(src.Config)
		m.Config = &tmp_Config
	} else {
		m.Config = nil
	}
...
func (m *ClusterCredentialsRequest) GetObjKey() objstore.ObjKey {
	return m.GetKey()
}

func (m *ClusterCredentialsRequest) GetKey() *ClusterKey {
	return &m.Key
}

func (m *ClusterCredentialsRequest) GetKeyVal() ClusterKey {
	return m.Key
}

func (m *ClusterCredentialsRequest) SetKey(key *ClusterKey) {
	m.Key = *key
}

func CmpSortClusterCredentialsRequest(a ClusterCredentialsRequest, b ClusterCredentialsRequest) bool {
	return a.Key.GetKeyString() < b.Key.GetKeyString()
}

// Helper method to check that enums have valid values
func (m *ClusterCredentialsRequest) ValidateEnums() error {
	if err := m.Key.ValidateEnums(); err != nil {
		return err
	}
	if m.Config != nil {
...
func (s *ClusterCredentialsRequest) ClearTagged(tags map[string]struct{}) {
	s.Key.ClearTagged(tags)
	if s.Config != nil {
...
func (m *ClusterCredentialsConfig) Clone() *ClusterCredentialsConfig {
	cp := &ClusterCredentialsConfig{}
	cp.DeepCopyIn(m)
	return cp
}

func (m *ClusterCredentialsConfig) CopyInFields(src *ClusterCredentialsConfig) int {
	changed := 0
	return changed
}

func (m *ClusterCredentialsConfig) DeepCopyIn(src *ClusterCredentialsConfig) {
}

// Helper method to check that enums have valid values
func (m *ClusterCredentialsConfig) ValidateEnums() error {
	return nil
}

func (s *ClusterCredentialsConfig) ClearTagged(tags map[string]struct{}) {
}

func (m *CloudletManagedClusterInfo) Clone() *CloudletManagedClusterInfo {
	cp := &CloudletManagedClusterInfo{}
	cp.DeepCopyIn(m)
	return cp
}

func (m *CloudletManagedClusterInfo) AddNodePools(vals ...*NodePool) int {
	changes := 0
	cur := make(map[string]struct{})
	for _, v := range m.NodePools {
		cur[v.String()] = struct{}{}
...
func (m *CloudletManagedClusterInfo) RemoveNodePools(vals ...*NodePool) int {
	changes := 0
	remove := make(map[string]struct{})
	for _, v := range vals {
		remove[v.String()] = struct{}{}
...
func (m *CloudletManagedClusterInfo) CopyInFields(src *CloudletManagedClusterInfo) int {
	updateListAction := "replace"
	changed := 0
	if m.KubernetesVersion != src.KubernetesVersion {
		m.KubernetesVersion = src.KubernetesVersion
...
func (m *CloudletManagedClusterInfo) DeepCopyIn(src *CloudletManagedClusterInfo) {
	m.KubernetesVersion = src.KubernetesVersion
	if src.NodePools != nil {
		m.NodePools = make([]*NodePool, len(src.NodePools), len(src.NodePools))
		for ii, s := range src.NodePools {
...
// Helper method to check that enums have valid values
func (m *CloudletManagedClusterInfo) ValidateEnums() error {
	for _, e := range m.NodePools {
		if err := e.ValidateEnums(); err != nil {
			return err
		}
...
func (s *CloudletManagedClusterInfo) ClearTagged(tags map[string]struct{}) {
	if s.NodePools != nil {
		for ii := 0; ii < len(s.NodePools); ii++ {
			s.NodePools[ii].ClearTagged(tags)
		}
...
func (m *ClusterInstInfo) Matches(o *ClusterInstInfo, fopts ...MatchOpt) bool {
	...
	if !opts.IgnoreBackend {
		if !opts.Filter || o.CloudletManagedClusterInfo != nil {
			if m.CloudletManagedClusterInfo == nil && o.CloudletManagedClusterInfo != nil || m.CloudletManagedClusterInfo != nil && o.CloudletManagedClusterInfo == nil {
				return false
			} else if m.CloudletManagedClusterInfo != nil && o.CloudletManagedClusterInfo != nil {
			}
		}
	}
	if !opts.IgnoreBackend {
...
const ClusterInstInfoFieldCloudletManagedClusterInfo = "8"
const ClusterInstInfoFieldCloudletManagedClusterInfoKubernetesVersion = "8.1"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePools = "8.2"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsName = "8.2.1"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNumNodes = "8.2.2"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources = "8.2.3"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesVcpus = "8.2.3.1"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesRam = "8.2.3.2"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesDisk = "8.2.3.3"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMap = "8.2.3.4"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMapKey = "8.2.3.4.1"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMapValue = "8.2.3.4.2"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesInfraNodeFlavor = "8.2.3.5"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesExternalVolumeSize = "8.2.3.6"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpus = "8.2.3.7"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusModelId = "8.2.3.7.1"
const ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusCount = "8.2.3.7.2"
...
var ClusterInstInfoAllFields = []string{
	...
	ClusterInstInfoFieldResourcesVmsContainers,
	ClusterInstInfoFieldResourcesVms,
	ClusterInstInfoFieldResources,
	ClusterInstInfoFieldCloudletManagedClusterInfoKubernetesVersion,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsName,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNumNodes,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesVcpus,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesRam,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesDisk,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMapKey,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMapValue,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMap,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesInfraNodeFlavor,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesExternalVolumeSize,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusModelId,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusCount,
	...
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpus,
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources,
	...
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePools,
	ClusterInstInfoFieldCloudletManagedClusterInfo,
	ClusterInstInfoFieldInfraAnnotationsKey,
	ClusterInstInfoFieldInfraAnnotationsValue,
	ClusterInstInfoFieldInfraAnnotations,
}
...
var ClusterInstInfoAllFieldsMap = NewFieldMap(map[string]struct{}{
	...
	ClusterInstInfoFieldKey:                                                                struct{}{},
	...
	ClusterInstInfoFieldStatus:                                                             struct{}{},
	...
	ClusterInstInfoFieldResourcesVmsContainers:                                             struct{}{},
	ClusterInstInfoFieldResourcesVms:                                                       struct{}{},
	ClusterInstInfoFieldResources:                                                          struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoKubernetesVersion:                        struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsName:                            struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNumNodes:                        struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesVcpus:              struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesRam:                struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesDisk:               struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMapKey:       struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMapValue:     struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMap:          struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesInfraNodeFlavor:    struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesExternalVolumeSize: struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusModelId:        struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusCount:          struct{}{},
	...
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpus:               struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources:                   struct{}{},
	...
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePools:                                struct{}{},
	ClusterInstInfoFieldCloudletManagedClusterInfo:                                         struct{}{},
	ClusterInstInfoFieldInfraAnnotationsKey:                                                struct{}{},
	ClusterInstInfoFieldInfraAnnotationsValue:                                              struct{}{},
	ClusterInstInfoFieldInfraAnnotations:                                                   struct{}{},
})
...
var ClusterInstInfoAllFieldsStringMap = map[string]string{
	...
	ClusterInstInfoFieldStatus:                                                             "Status",
	...
	ClusterInstInfoFieldResourcesVmsContainers:                                             "Resources Vms Containers",
	ClusterInstInfoFieldResourcesVms:                                                       "Resources Vms",
	ClusterInstInfoFieldResources:                                                          "Resources",
	ClusterInstInfoFieldCloudletManagedClusterInfoKubernetesVersion:                        "Cloudlet Managed Cluster Info Kubernetes Version",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsName:                            "Cloudlet Managed Cluster Info Node Pools Name",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNumNodes:                        "Cloudlet Managed Cluster Info Node Pools Num Nodes",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesVcpus:              "Cloudlet Managed Cluster Info Node Pools Node Resources Vcpus",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesRam:                "Cloudlet Managed Cluster Info Node Pools Node Resources Ram",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesDisk:               "Cloudlet Managed Cluster Info Node Pools Node Resources Disk",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMapKey:       "Cloudlet Managed Cluster Info Node Pools Node Resources Opt Res Map Key",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMapValue:     "Cloudlet Managed Cluster Info Node Pools Node Resources Opt Res Map Value",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMap:          "Cloudlet Managed Cluster Info Node Pools Node Resources Opt Res Map",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesInfraNodeFlavor:    "Cloudlet Managed Cluster Info Node Pools Node Resources Infra Node Flavor",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesExternalVolumeSize: "Cloudlet Managed Cluster Info Node Pools Node Resources External Volume Size",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusModelId:        "Cloudlet Managed Cluster Info Node Pools Node Resources Gpus Model Id",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusCount:          "Cloudlet Managed Cluster Info Node Pools Node Resources Gpus Count",
	...
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpus:               "Cloudlet Managed Cluster Info Node Pools Node Resources Gpus",
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources:                   "Cloudlet Managed Cluster Info Node Pools Node Resources",
	...
	ClusterInstInfoFieldCloudletManagedClusterInfoNodePools:                                "Cloudlet Managed Cluster Info Node Pools",
	ClusterInstInfoFieldCloudletManagedClusterInfo:                                         "Cloudlet Managed Cluster Info",
	...
	ClusterInstInfoFieldInfraAnnotations:                                                   "Infra Annotations",
}
...
var ClusterInstInfoBackendFieldsMap = map[string]struct{}{
	ClusterInstInfoFieldStatusTaskNumber:                                                   struct{}{},
	ClusterInstInfoFieldStatusMaxTasks:                                                     struct{}{},
	ClusterInstInfoFieldStatusTaskName:                                                     struct{}{},
	ClusterInstInfoFieldStatusStepName:                                                     struct{}{},
...
var ClusterInstInfoNoConfigFieldsMap = map[string]struct{}{}
...
func (m *ClusterInstInfo) DiffFields(o *ClusterInstInfo, fields *FieldMap) {
	...
	if m.CloudletManagedClusterInfo != nil && o.CloudletManagedClusterInfo != nil {
		if m.CloudletManagedClusterInfo.KubernetesVersion != o.CloudletManagedClusterInfo.KubernetesVersion {
			fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoKubernetesVersion)
			fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
		}
		if m.CloudletManagedClusterInfo.NodePools != nil && o.CloudletManagedClusterInfo.NodePools != nil {
			if len(m.CloudletManagedClusterInfo.NodePools) != len(o.CloudletManagedClusterInfo.NodePools) {
				fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
				fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
			} else {
				for i1 := 0; i1 < len(m.CloudletManagedClusterInfo.NodePools); i1++ {
					if m.CloudletManagedClusterInfo.NodePools[i1].Name != o.CloudletManagedClusterInfo.NodePools[i1].Name {
						fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsName)
						fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
						fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
					}
					if m.CloudletManagedClusterInfo.NodePools[i1].NumNodes != o.CloudletManagedClusterInfo.NodePools[i1].NumNodes {
						fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNumNodes)
						fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
						fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
					}
					if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources != nil && o.CloudletManagedClusterInfo.NodePools[i1].NodeResources != nil {
						if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Vcpus != o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Vcpus {
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesVcpus)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
						}
						if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Ram != o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Ram {
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesRam)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
						}
						if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Disk != o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Disk {
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesDisk)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
						}
						if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.OptResMap != nil && o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.OptResMap != nil {
							if len(m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.OptResMap) != len(o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.OptResMap) {
								fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMap)
								fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
								fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
								fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
							} else {
								for k3, _ := range m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.OptResMap {
									_, vok3 := o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.OptResMap[k3]
									if !vok3 {
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMap)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
										...
										if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.OptResMap[k3] != o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.OptResMap[k3] {
											fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMap)
											fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
											fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
											fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
						...
						} else if (m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.OptResMap != nil && o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.OptResMap == nil) || (m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.OptResMap == nil && o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.OptResMap != nil) {
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesOptResMap)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
						}
						if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.InfraNodeFlavor != o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.InfraNodeFlavor {
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesInfraNodeFlavor)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
						}
						if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.ExternalVolumeSize != o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.ExternalVolumeSize {
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesExternalVolumeSize)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
						}
						if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus != nil && o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus != nil {
							if len(m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus) != len(o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus) {
								fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpus)
								fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
								fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
								fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
							} else {
								for i3 := 0; i3 < len(m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus); i3++ {
									if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus[i3].ModelId != o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus[i3].ModelId {
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusModelId)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpus)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
									}
									if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus[i3].Count != o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus[i3].Count {
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusCount)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpus)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
									}
									if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus[i3].Vendor != o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus[i3].Vendor {
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusVendor)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpus)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
									}
									if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus[i3].Memory != o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus[i3].Memory {
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusMemory)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpus)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
									}
									if m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus[i3].InUse != o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus[i3].InUse {
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpusInUse)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpus)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
										fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
						...
						} else if (m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus != nil && o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus == nil) || (m.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus == nil && o.CloudletManagedClusterInfo.NodePools[i1].NodeResources.Gpus != nil) {
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResourcesGpus)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePoolsNodeResources)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
							fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
					...
					if m.CloudletManagedClusterInfo.NodePools[i1].Scalable != o.CloudletManagedClusterInfo.NodePools[i1].Scalable {
		...
		} else if (m.CloudletManagedClusterInfo.NodePools != nil && o.CloudletManagedClusterInfo.NodePools == nil) || (m.CloudletManagedClusterInfo.NodePools == nil && o.CloudletManagedClusterInfo.NodePools != nil) {
			fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfoNodePools)
			fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
		}
	} else if (m.CloudletManagedClusterInfo != nil && o.CloudletManagedClusterInfo == nil) || (m.CloudletManagedClusterInfo == nil && o.CloudletManagedClusterInfo != nil) {
		fields.Set(ClusterInstInfoFieldCloudletManagedClusterInfo)
	}
	if m.InfraAnnotations != nil && o.InfraAnnotations != nil {
		if len(m.InfraAnnotations) != len(o.InfraAnnotations) {
...
func (m *ClusterInstInfo) AddCloudletManagedClusterInfoNodePools(vals ...*NodePool) int {
	changes := 0
	cur := make(map[string]struct{})
	for _, v := range m.CloudletManagedClusterInfo.NodePools {
		cur[v.String()] = struct{}{}
	}
	for _, v := range vals {
		if _, found := cur[v.String()]; found {
		...
		m.CloudletManagedClusterInfo.NodePools = append(m.CloudletManagedClusterInfo.NodePools, v)
		changes++
	}
	return changes
}

func (m *ClusterInstInfo) RemoveCloudletManagedClusterInfoNodePools(vals ...*NodePool) int {
	changes := 0
	remove := make(map[string]struct{})
	for _, v := range vals {
		remove[v.String()] = struct{}{}
	}
	for i := len(m.CloudletManagedClusterInfo.NodePools); i >= 0; i-- {
		if _, found := remove[m.CloudletManagedClusterInfo.NodePools[i].String()]; found {
			m.CloudletManagedClusterInfo.NodePools = append(m.CloudletManagedClusterInfo.NodePools[:i], m.CloudletManagedClusterInfo.NodePools[i+1:]...)
			changes++
		}
	}
	return changes
...
func (m *ClusterInstInfo) CopyInFields(src *ClusterInstInfo) int {
	...
	if fmap.HasOrHasChild("8") {
		if src.CloudletManagedClusterInfo != nil {
			if m.CloudletManagedClusterInfo == nil {
				m.CloudletManagedClusterInfo = &CloudletManagedClusterInfo{}
			}
			if fmap.Has("8.1") {
				if m.CloudletManagedClusterInfo.KubernetesVersion != src.CloudletManagedClusterInfo.KubernetesVersion {
					m.CloudletManagedClusterInfo.KubernetesVersion = src.CloudletManagedClusterInfo.KubernetesVersion
					changed++
				}
			}
			if fmap.HasOrHasChild("8.2") {
				if src.CloudletManagedClusterInfo.NodePools != nil {
					if updateListAction == "add" {
						changed += m.AddCloudletManagedClusterInfoNodePools(src.CloudletManagedClusterInfo.NodePools...)
					} else if updateListAction == "remove" {
						changed += m.RemoveCloudletManagedClusterInfoNodePools(src.CloudletManagedClusterInfo.NodePools...)
					} else {
						m.CloudletManagedClusterInfo.NodePools = make([]*NodePool, 0)
						for k1, _ := range src.CloudletManagedClusterInfo.NodePools {
							m.CloudletManagedClusterInfo.NodePools = append(m.CloudletManagedClusterInfo.NodePools, src.CloudletManagedClusterInfo.NodePools[k1].Clone())
						}
						changed++
					}
				} else if m.CloudletManagedClusterInfo.NodePools != nil {
					m.CloudletManagedClusterInfo.NodePools = nil
					changed++
				}
			}
		} else if m.CloudletManagedClusterInfo != nil {
			m.CloudletManagedClusterInfo = nil
			changed++
		}
	}
	if fmap.HasOrHasChild("45") {
...
func (m *ClusterInstInfo) DeepCopyIn(src *ClusterInstInfo) {
	...
	m.Resources.DeepCopyIn(&src.Resources)
	if src.CloudletManagedClusterInfo != nil {
		var tmp_CloudletManagedClusterInfo CloudletManagedClusterInfo
		tmp_CloudletManagedClusterInfo.DeepCopyIn(src.CloudletManagedClusterInfo)
		m.CloudletManagedClusterInfo = &tmp_CloudletManagedClusterInfo
	} else {
		m.CloudletManagedClusterInfo = nil
	}
	if src.InfraAnnotations != nil {
...
func (m *ClusterInstInfo) ValidateEnums() error {
	...
	if m.CloudletManagedClusterInfo != nil {
		if err := m.CloudletManagedClusterInfo.ValidateEnums(); err != nil {
			return err
		}
	}
	return nil
...
func (s *ClusterInstInfo) ClearTagged(tags map[string]struct{}) {
	...
	s.Resources.ClearTagged(tags)
	if s.CloudletManagedClusterInfo != nil {
		s.CloudletManagedClusterInfo.ClearTagged(tags)
	}
}
...
func (m *ClusterCredentialsRequest) IsValidArgsForGetClusterCredentials() error {
	return nil
}
...
func (m *ClusterInst) Size() (n int) {
	...
	l = len(m.CloudletManagedClusterId)
	if l > 0 {
		n += 2 + l + sovClusterinst(uint64(l))
	}
	l = len(m.CloudletManagedClusterName)
	if l > 0 {
		n += 2 + l + sovClusterinst(uint64(l))
	}
...
func (m *ClusterCredentialsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ClusterCredentialsConfig) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CloudletManagedClusterInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ClusterInstInfo) Size() (n int) {
	...
	n += 1 + l + sovClusterinst(uint64(l))
	if m.CloudletManagedClusterInfo != nil {
		l = m.CloudletManagedClusterInfo.Size()
		n += 1 + l + sovClusterinst(uint64(l))
	}
	if len(m.InfraAnnotations) > 0 {
		for k, v := range m.InfraAnnotations {
...
func (m *ClusterInst) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 49:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableDynamicAppinstPlacement", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DisableDynamicAppinstPlacement = bool(v != 0)
		case 50:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CloudletManagedClusterId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CloudletManagedClusterId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 51:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CloudletManagedClusterName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CloudletManagedClusterName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 52:
			if wireType != 2 {
		...
		case 53:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkipCrmCleanupOnTimeout", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SkipCrmCleanupOnTimeout = bool(v != 0)
		case 100:
			if wireType != 2 {
...
func (m *ClusterCredentialsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClusterCredentialsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClusterCredentialsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ClusterCredentialsConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClusterCredentialsConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClusterCredentialsConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *CloudletManagedClusterInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CloudletManagedClusterInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CloudletManagedClusterInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ClusterInstInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CloudletManagedClusterInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CloudletManagedClusterInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 45:
