...
const (
	...
	// Kubernetes via cloudlet operator
	PlatformType_PLATFORM_TYPE_K8S_OPERATOR PlatformType = 18
)
...
type PlatformFeatures struct {
	...
	SupportsMultiTenantCluster bool `protobuf:"varint,1,opt,name=supports_multi_tenant_cluster,json=supportsMultiTenantCluster,proto3" json:"supports_multi_tenant_cluster,omitempty"`
	// Platform supports shared volumes
	SupportsSharedVolume bool `protobuf:"varint,2,opt,name=supports_shared_volume,json=supportsSharedVolume,proto3" json:"supports_shared_volume,omitempty"`
	// Platform supports trust policies
	SupportsTrustPolicy bool `protobuf:"varint,3,opt,name=supports_trust_policy,json=supportsTrustPolicy,proto3" json:"supports_trust_policy,omitempty"`
	// Platform only supports kubernetes deployments
	SupportsKubernetesOnly bool `protobuf:"varint,4,opt,name=supports_kubernetes_only,json=supportsKubernetesOnly,proto3" json:"supports_kubernetes_only,omitempty"`
	// Kubernetes clusters requires worker nodes and cannot be master only
	KubernetesRequiresWorkerNodes bool `protobuf:"varint,5,opt,name=kubernetes_requires_worker_nodes,json=kubernetesRequiresWorkerNodes,proto3" json:"kubernetes_requires_worker_nodes,omitempty"`
	// Cloudlet servicess run local to the controller
	CloudletServicesLocal bool `protobuf:"varint,6,opt,name=cloudlet_services_local,json=cloudletServicesLocal,proto3" json:"cloudlet_services_local,omitempty"`
	// Every kubernetes services gets a public IP (public cloud)
	IpAllocatedPerService bool `protobuf:"varint,7,opt,name=ip_allocated_per_service,json=ipAllocatedPerService,proto3" json:"ip_allocated_per_service,omitempty"`
	// Platform supports OVF images for VM deployments
	SupportsImageTypeOvf bool `protobuf:"varint,8,opt,name=supports_image_type_ovf,json=supportsImageTypeOvf,proto3" json:"supports_image_type_ovf,omitempty"`
	// Platform is a a pool of pre-existing virtual machines
	IsVmPool bool `protobuf:"varint,9,opt,name=is_vm_pool,json=isVmPool,proto3" json:"is_vm_pool,omitempty"`
	...
	SupportsAdditionalNetworks bool `protobuf:"varint,11,opt,name=supports_additional_networks,json=supportsAdditionalNetworks,proto3" json:"supports_additional_networks,omitempty"`
	// The entire platform is a single kubernetes cluster
	IsSingleKubernetesCluster bool `protobuf:"varint,12,opt,name=is_single_kubernetes_cluster,json=isSingleKubernetesCluster,proto3" json:"is_single_kubernetes_cluster,omitempty"`
	// Platform supports per AppInst dedicated IPs
	SupportsAppInstDedicatedIp bool `protobuf:"varint,13,opt,name=supports_app_inst_dedicated_ip,json=supportsAppInstDedicatedIp,proto3" json:"supports_app_inst_dedicated_ip,omitempty"`
	// Supports high availability with two CRMs on kubernetes
	SupportsPlatformHighAvailabilityOnK8S bool `protobuf:"varint,14,opt,name=supports_platform_high_availability_on_k8s,json=supportsPlatformHighAvailabilityOnK8s,proto3" json:"supports_platform_high_availability_on_k8s,omitempty"`
	// Supports high availability with two CRMs on docker
	SupportsPlatformHighAvailabilityOnDocker bool `protobuf:"varint,15,opt,name=supports_platform_high_availability_on_docker,json=supportsPlatformHighAvailabilityOnDocker,proto3" json:"supports_platform_high_availability_on_docker,omitempty"`
	// No support for kubernetes cluster auto-scale
	NoKubernetesClusterAutoScale bool `protobuf:"varint,16,opt,name=no_kubernetes_cluster_auto_scale,json=noKubernetesClusterAutoScale,proto3" json:"no_kubernetes_cluster_auto_scale,omitempty"`
	// Kubernetes cluster is created externally and already exists
	IsPrebuiltKubernetesCluster bool `protobuf:"varint,17,opt,name=is_prebuilt_kubernetes_cluster,json=isPrebuiltKubernetesCluster,proto3" json:"is_prebuilt_kubernetes_cluster,omitempty"`
}
...
var fileDescriptor_3aea31a648a25d86 = []byte{
	// 6313 bytes of a gzipped FileDescriptorProto
	,
}
...
type CloudletApiClient interface {
	...
	// Get Cloudlet platform features
	GetCloudletPlatformFeatures(ctx context.Context, in *CloudletKey, opts ...grpc.CallOption) (*PlatformFeatures, error)
...
func (c *cloudletApiClient) GetCloudletPlatformFeatures(ctx context.Context, in *CloudletKey, opts ...grpc.CallOption) (*PlatformFeatures, error) {
	out := new(PlatformFeatures)
	err := c.cc.Invoke(ctx, "/edgeproto.CloudletApi/GetCloudletPlatformFeatures", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CloudletApiServer interface {
	...
	// Get Cloudlet platform features
	GetCloudletPlatformFeatures(context.Context, *CloudletKey) (*PlatformFeatures, error)
	// Get Cloudlet Properties. Shows all the infra properties used to setup cloudlet
...
func (*UnimplementedCloudletApiServer) GetCloudletPlatformFeatures(ctx context.Context, req *CloudletKey) (*PlatformFeatures, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCloudletPlatformFeatures not implemented")
}
...
func _CloudletApi_GetCloudletPlatformFeatures_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CloudletKey)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CloudletApiServer).GetCloudletPlatformFeatures(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/edgeproto.CloudletApi/GetCloudletPlatformFeatures",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CloudletApiServer).GetCloudletPlatformFeatures(ctx, req.(*CloudletKey))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CloudletApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCloudletPlatformFeatures",
			Handler:    _CloudletApi_GetCloudletPlatformFeatures_Handler,
		},
		{
...
const (
	...
	PlatformTypePLATFORM_TYPE_K8S_OPERATOR        uint64 = 1 << 18
)
...
var PlatformType_CamelName = map[int32]string{
	...
	// PLATFORM_TYPE_K8S_OPERATOR -> PlatformTypeK8SOperator
	18: "PlatformTypeK8SOperator",
}
...
func (m *CloudletKey) IsValidArgsForGetCloudletPlatformFeatures() error {
	return nil
}
