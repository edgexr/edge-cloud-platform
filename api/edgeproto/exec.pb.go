...
type ExecRequest struct {
	...
	EdgeTurnProxyAddr string `protobuf:"bytes,16,opt,name=edge_turn_proxy_addr,json=edgeTurnProxyAddr,proto3" json:"edge_turn_proxy_addr,omitempty"`
}
...
var fileDescriptor_4d737c7315c25422 = []byte{
	...
	,
}
...
func (m *ExecRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.EdgeTurnProxyAddr) > 0 {
		i -= len(m.EdgeTurnProxyAddr)
		copy(dAtA[i:], m.EdgeTurnProxyAddr)
		i = encodeVarintExec(dAtA, i, uint64(len(m.EdgeTurnProxyAddr)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x82
...
func (m *ExecRequest) CopyInFields(src *ExecRequest) int {
	...
	if m.EdgeTurnProxyAddr != src.EdgeTurnProxyAddr {
...
func (m *ExecRequest) Size() (n int) {
	...
	l = len(m.EdgeTurnProxyAddr)
	if l > 0 {
		n += 2 + l + sovExec(uint64(l))
	}
	return n
}
...
func (m *ExecRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EdgeTurnProxyAddr", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EdgeTurnProxyAddr = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipExec(dAtA[iNdEx:])
