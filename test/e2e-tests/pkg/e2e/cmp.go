...
func cmpFilterAllData(data *ormapi.AllData) {
	...
	tx.AddSetZeroTypeField(ormapi.Federator{}, "FederationId")
	tx.AddSetZeroTypeField(ormapi.Federator{}, "InitialDate")
	tx.AddSetZeroTypeField(ormapi.FederationProvider{}, "FederationContextId")
	tx.AddSetZeroTypeField(ormapi.FederationProvider{}, "ProviderClientId")
	tx.AddSetZeroTypeField(ormapi.FederationProvider{}, "PartnerNotifyClientId")
	tx.AddSetZeroTypeField(ormapi.FederationProvider{}, "CreatedAt")
	tx.AddSetZeroTypeField(ormapi.FederationProvider{}, "UpdatedAt")
	tx.AddSetZeroTypeField(ormapi.FederationConsumer{}, "FederationContextId")
	tx.AddSetZeroTypeField(ormapi.FederationConsumer{}, "ProviderClientId")
	tx.AddSetZeroTypeField(ormapi.FederationConsumer{}, "NotifyClientId")
	tx.AddSetZeroTypeField(ormapi.FederationConsumer{}, "CreatedAt")
	tx.AddSetZeroTypeField(ormapi.FederationConsumer{}, "UpdatedAt")
	tx.ReplaceStringField(ormapi.ConsumerImage{}, "***id***", "ID")
	tx.ReplaceStringField(ormapi.ProviderImage{}, "***fileid***", "FileID")
	tx.AddSetZeroTypeField(edgeproto.FederationConfig{}, "FederationContextId")
	tx.Apply(data)
