...
func TestAccessClientServer(t *testing.T) {
	...
	require.Nil(t, err)
	// init client
	err = tc1.KeyClient.init(initCtx, SvcNodeTypeCRM, CertIssuerRegionalCloudlet, tc1.Cloudlet.Key, deploymentTag, process.HARolePrimary)
	require.Nil(t, err)
	...
	// run init (upgrade)
	err = tc2.KeyClient.init(initCtx, SvcNodeTypeCRM, CertIssuerRegionalCloudlet, tc2.Cloudlet.Key, deploymentTag, process.HARolePrimary)
	require.Nil(t, err)
	...
	err = tc3.KeyClient.init(initCtx, SvcNodeTypeCRM, CertIssuerRegionalCloudlet, tc3.Cloudlet.Key, deploymentTag, process.HARolePrimary)
	require.NotNil(t, err)
	...
	err = tc4.KeyClient.init(initCtx, SvcNodeTypeDME, CertIssuerRegionalCloudlet, tc4.Cloudlet.Key, deploymentTag, process.HARolePrimary)
	require.Nil(t, err)
	// mark key for upgrade
	...
	require.Nil(t, err)
	// init client
	err = tc5.KeyClient.init(initCtx, SvcNodeTypeCRM, CertIssuerRegionalCloudlet, tc5.Cloudlet.Key, deploymentTag, process.HARolePrimary)
	require.Nil(t, err)
