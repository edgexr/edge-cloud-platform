...
var CloudletAliasArgs = []string{
	...
	"federationconfig.appinststatuseventpath=cloudlet.federationconfig.appinststatuseventpath",
...
var CloudletComments = map[string]string{
	...
	"federationconfig.appinststatuseventpath": "Federation app inst status callback path",
	"licenseconfigstoragepath":                "GPU driver license config storage path",
}
