...
var ShowPlatformFeaturesCmd = &ApiCommand{
	Name:         "ShowPlatformFeatures",
	Use:          "show",
	Short:        "Show Platform Features. Shows supported cloudlet platform types and their features.",
	RequiredArgs: "region",
	...
	Path:         "/auth/ctrl/ShowPlatformFeatures",
	StreamOut:    true,
	ProtobufApi:  true,
}

var DeletePlatformFeaturesCmd = &ApiCommand{
	Name:         "DeletePlatformFeatures",
	Use:          "delete",
	Short:        "Delete Platform Features. Removes a no-longer supported platform type. Admin only.",
	RequiredArgs: "region " + strings.Join(PlatformFeaturesRequiredArgs, " "),
	...
	Path:         "/auth/ctrl/DeletePlatformFeatures",
	ProtobufApi:  true,
}
var PlatformFeaturesApiCmds = []*ApiCommand{
	ShowPlatformFeaturesCmd,
	DeletePlatformFeaturesCmd,
}

const PlatformFeaturesGroup = "PlatformFeatures"

func init() {
	AllApis.AddGroup(PlatformFeaturesGroup, "Manage PlatformFeatures", PlatformFeaturesApiCmds)
}
...
var UpdateCloudletCmd = &ApiCommand{
	...
	SpecialArgs:          &CloudletSpecialArgs,
	Comments:             addRegionComment(CloudletComments),
	NoConfig:             "Location.HorizontalAccuracy,Location.VerticalAccuracy,Location.Course,Location.Speed,Location.Timestamp,Config,ChefClientKey,State,Errors,CrmAccessPublicKey,CrmAccessKeyUpgradeRequired,SecondaryCrmAccessPublicKey,SecondaryCrmAccessKeyUpgradeRequired,CreatedAt,UpdatedAt,TrustPolicyState,HostController,DeletePrepare,GpuConfig.LicenseConfigMd5Sum,DnsLabel,RootLbFqdn,FederationConfig,LicenseConfigStoragePath,PlatformType,DeploymentLocal,Flavor,PhysicalName,ContainerVersion,ResTagMap,VmImageVersion,Deployment,InfraApiAccess,InfraConfig,OverridePolicyContainerVersion,VmPool,ResTagMap,EdgeboxOnly",
	ReqData:              &ormapi.RegionCloudlet{},
	ReplyData:            &edgeproto.Result{},
...
var PlatformFeaturesAliasArgs = []string{
	...
	"nodetype=platformfeatures.nodetype",
	...
	"supportsimagetypeova=platformfeatures.supportsimagetypeova",
	"isvmpool=platformfeatures.isvmpool",
	"isfake=platformfeatures.isfake",
	"ismock=platformfeatures.ismock",
	...
	"noclustersupport=platformfeatures.noclustersupport",
	"isedgebox=platformfeatures.isedgebox",
	"supportsipv6=platformfeatures.supportsipv6",
	"resourcequotaproperties:#.name=platformfeatures.resourcequotaproperties:#.name",
	"resourcequotaproperties:#.value=platformfeatures.resourcequotaproperties:#.value",
	"resourcequotaproperties:#.inframaxvalue=platformfeatures.resourcequotaproperties:#.inframaxvalue",
	"resourcequotaproperties:#.quotamaxvalue=platformfeatures.resourcequotaproperties:#.quotamaxvalue",
	"resourcequotaproperties:#.description=platformfeatures.resourcequotaproperties:#.description",
	"resourcequotaproperties:#.units=platformfeatures.resourcequotaproperties:#.units",
	"resourcequotaproperties:#.alertthreshold=platformfeatures.resourcequotaproperties:#.alertthreshold",
	"deleteprepare=platformfeatures.deleteprepare",
}
...
var CloudletAliasArgs = []string{
	...
	"onboardingstate=cloudlet.onboardingstate",
	...
	"config.ansiblepublicaddr=cloudlet.config.ansiblepublicaddr",
	"config.internaldomain=cloudlet.config.internaldomain",
	...
	"edgeboxonly=cloudlet.edgeboxonly",
}
...
var CloudletInfoAliasArgs = []string{
	...
	"resourcessnapshot.clusterinsts:#.name=cloudletinfo.resourcessnapshot.clusterinsts:#.name",
	"resourcessnapshot.clusterinsts:#.organization=cloudletinfo.resourcessnapshot.clusterinsts:#.organization",
	"resourcessnapshot.vmappinsts:#.name=cloudletinfo.resourcessnapshot.vmappinsts:#.name",
	"resourcessnapshot.vmappinsts:#.organization=cloudletinfo.resourcessnapshot.vmappinsts:#.organization",
	"resourcessnapshot.k8sappinsts:#.name=cloudletinfo.resourcessnapshot.k8sappinsts:#.name",
	"resourcessnapshot.k8sappinsts:#.organization=cloudletinfo.resourcessnapshot.k8sappinsts:#.organization",
...
var CloudletInfoComments = map[string]string{
	...
	"resourcessnapshot.vmappinsts:#.name":                      "AppInst name",
	"resourcessnapshot.vmappinsts:#.organization":              "AppInst organization",
	"resourcessnapshot.k8sappinsts:#.name":                     "AppInst name",
	"resourcessnapshot.k8sappinsts:#.organization":             "AppInst organization",
