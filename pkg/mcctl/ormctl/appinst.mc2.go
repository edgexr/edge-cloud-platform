...
var CreateAppInstCmd = &ApiCommand{
	...
	NoConfig:             "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,InternalPortToLbIp,UniqueId,DnsLabel,FedKey,UpdateMultiple,ForceUpdate,PowerState",
...
var DeleteAppInstCmd = &ApiCommand{
	...
	SpecialArgs:          &AppInstSpecialArgs,
	Comments:             addRegionComment(AppInstComments),
	NoConfig:             "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,InternalPortToLbIp,UniqueId,DnsLabel,FedKey,PowerState",
	ReqData:              &ormapi.RegionAppInst{},
	ReplyData:            &edgeproto.Result{},
...
var RefreshAppInstCmd = &ApiCommand{
	...
	SpecialArgs:          &AppInstSpecialArgs,
	Comments:             addRegionComment(AppInstComments),
	NoConfig:             "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,InternalPortToLbIp,UniqueId,DnsLabel,FedKey,Flavor,AutoClusterIpAccess,Configs,PowerState,HealthCheck,SharedVolumeSize,VmFlavor",
	ReqData:              &ormapi.RegionAppInst{},
	ReplyData:            &edgeproto.Result{},
...
var UpdateAppInstCmd = &ApiCommand{
	...
	SpecialArgs:          &AppInstSpecialArgs,
	Comments:             addRegionComment(AppInstComments),
	NoConfig:             "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,InternalPortToLbIp,UniqueId,DnsLabel,FedKey,Flavor,AutoClusterIpAccess,UpdateMultiple,ForceUpdate,HealthCheck,SharedVolumeSize,VmFlavor",
	ReqData:              &ormapi.RegionAppInst{},
	ReplyData:            &edgeproto.Result{},
