...
var AlertReceiverAliasArgs = []string{
	...
	"cloudletfedorg=appinstkey.cloudletkey.federatedorganization",
...
var AlertReceiverArgsComments = map[string]string{
	...
	"appinstorg":              "Organization or Company name of the App Instance",
	"appinst":                 "App Instance name",
	"cloudlet":                "Cloudlet name where app instance is deployed",
	"cloudletorg":             "Company or Organization that owns the cloudlet",
	"cloudletfedorg":          "Federation Organization of the cloudlet",
