...
var AlertReceiverAliasArgs = []string{
	...
	"appinstcloudletorg=appinstkey.cloudletkey.organization",
	"appinstcloudletfedorg=appinstkey.cloudletkey.federatedorganization",
	"appinstcloudlet=appinstkey.cloudletkey.name",
	"cluster=clusterinstkey.clusterkey.name",
	"clusterorg=clusterinstkey.clusterkey.organization",
	"clustercloudlet=clusterinstkey.cloudletkey.name",
	"clustercloudletorg=clusterinstkey.cloudletkey.organization",
	"clustercloudletfedorg=clusterinstkey.cloudletkey.federatedorganization",
	"cloudletorg=cloudletkey.organization",
	"cloudletfedorg=cloudletkey.federatedorganization",
