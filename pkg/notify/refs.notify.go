...
func (s *ClusterRefsSend) updateInternal(ctx context.Context, key *edgeproto.ClusterInstKey, modRev int64) {
	s.Mux.Lock()
...
func (s *AppInstRefsSend) updateInternal(ctx context.Context, key *edgeproto.AppKey, modRev int64) {
	s.Mux.Lock()
