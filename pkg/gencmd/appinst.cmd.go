...
var AppInstOptionalArgs = []string{
	...
	"kubernetesresources.cpupool.topology.minnodecpus",
	...
	"kubernetesresources.gpupool.topology.minnodecpus",
...
var AppInstComments = map[string]string{
	...
	"flavor":                                 "Flavor name",
	"cloudletflavor":                         "(_deprecated_) Cloudlet-specific flavor instead of regional flavor, replaced by NodeResources/KubernetesResources CloudletNodeFlavor.",
	...
	"vmflavor":                               "(_deprecated_) Replaced by NodeResources.CloudletNodeFlavor; OS node flavor to use",
	"optres":                                 "(_deprecated_) Replaced by NodeResources.OptRes; Optional Resources required by OS flavor if any",
	...
	"kubernetesresources.cpupool.topology.minnodecpus":      "Minimum number of vcpus per node",
	...
	"kubernetesresources.gpupool.topology.minnodecpus":      "Minimum number of vcpus per node",
