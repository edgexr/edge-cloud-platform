...
var PlatformFeaturesComments = map[string]string{
	...
	"kubernetesmanagedcontrolplane":            "Platform manages the control plane for the cluster, user has no control or access, and cannot run workloads on the control plane.",
