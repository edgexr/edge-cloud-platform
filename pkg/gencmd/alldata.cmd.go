...
var AllDataComments = map[string]string{
	...
	"platformfeatures:#.kubernetesmanagedcontrolplane":                           "Platform manages the control plane for the cluster, user has no control or access, and cannot run workloads on the control plane.",
