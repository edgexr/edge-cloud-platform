...
var AllDataOptionalArgs = []string{
	...
	"platformfeatures:#.kubernetesmanagedcontrolplane",
	...
	"platformfeatures:#.resourcecalcbyflavorcounts",
	"platformfeatures:#.supportsbaremetal",
	...
	"cloudlets:#.singlekubernetesnamespace",
	...
	"clusterinsts:#.singlekubernetesnamespace",
	"clusterinsts:#.skipcrmcleanupontimeout",
	"clusterinsts:#.tags",
	"apps:#.fields",
	...
	"appinstances:#.mappedports:#.hostprefix",
...
var AllDataComments = map[string]string{
	...
	"platformfeatures:#.kubernetesmanagedcontrolplane":                           "Platform manages the control plane for the cluster, user has no control or access, and cannot run workloads on the control plane. Note this infers that worker nodes are required.",
	...
	"platformfeatures:#.resourcecalcbyflavorcounts":                              "Resource calculation done in terms of flavor counts instead of individual vcpus, ram, etc",
	"platformfeatures:#.supportsbaremetal":                                       "Platform supports bare metal",
	...
	"cloudlets:#.crmoverride":                                                    "Override actions to CRM, one of NoOverride, IgnoreCrmErrors, IgnoreCrm, IgnoreTransientState, IgnoreCrmAndTransientState, IgnoreCrmTimeoutError",
	...
	"cloudlets:#.singlekubernetesnamespace":                                      "For single kubernetes cluster cloudlet platforms, deployments are limited to the specified namespace.",
	...
	"cloudletinfos:#.nodepools:#.controlplane":                                   "Node pool hosts the kubernetes control plane",
	...
	"clusterinsts:#.crmoverride":                                                 "Override actions to CRM, one of NoOverride, IgnoreCrmErrors, IgnoreCrm, IgnoreTransientState, IgnoreCrmAndTransientState, IgnoreCrmTimeoutError",
	...
	"clusterinsts:#.nodepools:#.controlplane":                                    "Node pool hosts the kubernetes control plane",
	"clusterinsts:#.infraannotations":                                            "Annotations added by the implementing infrastructure",
	"clusterinsts:#.kubernetesversion":                                           "Kubernetes version of cluster if applicable, semver format, i.e. v1.34.0",
	...
	"clusterinsts:#.singlekubernetesnamespace":                                   "Restricted namespace for the default cluster on a single kubernetes cluster cloudlet",
	"clusterinsts:#.skipcrmcleanupontimeout":                                     "Prevents cleanup of resources on timeout within CRM, used for diagnostic purposes",
	...
	"appinstances:#.mappedports:#.hostprefix":                                   "Host prefix for HTTP ports in Kubernetes ingress",
	...
	"appinstances:#.crmoverride":                                                "Override actions to CRM, one of NoOverride, IgnoreCrmErrors, IgnoreCrm, IgnoreTransientState, IgnoreCrmAndTransientState, IgnoreCrmTimeoutError",
	...
	"appinstances:#.namespace":                                                  "Target kubernetes namespace, can only be specified for dedicated clusters",
	...
	"vmpools:#.crmoverride":                                                     "Override actions to CRM, one of NoOverride, IgnoreCrmErrors, IgnoreCrm, IgnoreTransientState, IgnoreCrmAndTransientState, IgnoreCrmTimeoutError",
