...
var AllDataOptionalArgs = []string{
	...
	"platformfeatures:#.requireslbipallocation",
...
var AllDataComments = map[string]string{
	...
	"platformfeatures:#.requireslbipallocation":                                  "Platform uses requires load balancer IP allocation, typically for bare-metal with reservable floating IPs. Supported values are kube-vip.",
