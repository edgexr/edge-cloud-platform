...
var AllDataOptionalArgs = []string{
	...
	"apps:#.kubernetesresources.cpupool.topology.minnodecpus",
	...
	"apps:#.kubernetesresources.gpupool.topology.minnodecpus",
	...
	"appinstances:#.kubernetesresources.cpupool.topology.minnodecpus",
	...
	"appinstances:#.kubernetesresources.gpupool.topology.minnodecpus",
...
var AllDataComments = map[string]string{
	...
	"platformfeatures:#.supportsmultiplenodepools":                               "Kubernetes clusters support multiple node pools",
	...
	"clusterinsts:#.nodeflavor":                                                  "(_deprecated_) Replaced by NodePools.CloudletNodeFlavor. Cloudlet specific node flavor.",
	...
	"clusterinsts:#.numnodes":                                                    "(_deprecated_) Replaced by NodePools.NumNodes. Number of k8s nodes (In case of docker deployment, this field is not required)",
	"clusterinsts:#.externalvolumesize":                                          "(_deprecated_) Size of external volume to be attached to nodes.  This is for the root partition",
	...
	"apps:#.kubernetesresources.cpupool.topology.minnodecpus":                    "Minimum number of vcpus per node",
	...
	"apps:#.kubernetesresources.gpupool.topology.minnodecpus":                    "Minimum number of vcpus per node",
	...
	"appinstances:#.cloudletflavor":                                              "(_deprecated_) Cloudlet-specific flavor instead of regional flavor, replaced by NodeResources/KubernetesResources CloudletNodeFlavor.",
	...
	"appinstances:#.vmflavor":                                                    "(_deprecated_) Replaced by NodeResources.CloudletNodeFlavor; OS node flavor to use",
	"appinstances:#.optres":                                                      "(_deprecated_) Replaced by NodeResources.OptRes; Optional Resources required by OS flavor if any",
	...
	"appinstances:#.kubernetesresources.cpupool.topology.minnodecpus":            "Minimum number of vcpus per node",
	...
	"appinstances:#.kubernetesresources.gpupool.topology.minnodecpus":            "Minimum number of vcpus per node",
