...
var AllDataComments = map[string]string{
	...
	"gpudrivers:#.builds:#.driverpath":                                           "Path where the driver package is located, must be either a public path or the URL to the driver uploaded to the internal VM registry.",
	...
	"gpudrivers:#.licenseconfig":                                                 "URL License config file to setup license",
