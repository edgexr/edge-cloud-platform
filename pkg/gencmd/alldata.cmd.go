...
var AllDataComments = map[string]string{
	...
	"apps:#.managesownnamespaces":                                               "This is a placeholder until we allow for specifying the target namespace for Kubernetes apps. For now, this bypasses the automatic namespace allocation and deploys the application to the default namespace.",
