...
func AllDataHideTags(in *edgeproto.AllData) {
	...
	for i0 := 0; i0 < len(in.Zones); i0++ {
		for i1 := 0; i1 < len(in.Zones[i0].InfraFlavors); i1++ {
			for i2 := 0; i2 < len(in.Zones[i0].InfraFlavors[i1].Gpus); i2++ {
			}
		}
	...
	for i0 := 0; i0 < len(in.Cloudlets); i0++ {
		...
		for i1 := 0; i1 < len(in.Cloudlets[i0].InfraFlavors); i1++ {
			for i2 := 0; i2 < len(in.Cloudlets[i0].InfraFlavors[i1].Gpus); i2++ {
			}
		}
		if _, found := tags["nocmp"]; found {
	...
	for i0 := 0; i0 < len(in.CloudletInfos); i0++ {
		...
		for i1 := 0; i1 < len(in.CloudletInfos[i0].Flavors); i1++ {
			for i2 := 0; i2 < len(in.CloudletInfos[i0].Flavors[i1].Gpus); i2++ {
			}
		}
		if _, found := tags["nocmp"]; found {
		...
		for i1 := 0; i1 < len(in.CloudletInfos[i0].NodeInfos); i1++ {
			for i2 := 0; i2 < len(in.CloudletInfos[i0].NodeInfos[i1].Gpus); i2++ {
			}
		}
		for i1 := 0; i1 < len(in.CloudletInfos[i0].NodePools); i1++ {
			for i3 := 0; i3 < len(in.CloudletInfos[i0].NodePools[i1].NodeResources.Gpus); i3++ {
			}
		}
	}
	...
	for i0 := 0; i0 < len(in.Nodes); i0++ {
		for i2 := 0; i2 < len(in.Nodes[i0].NodeResources.Gpus); i2++ {
		}
		if _, found := tags["nocmp"]; found {
			in.Nodes[i0].ObjId = ""
		}
	}
	for i0 := 0; i0 < len(in.CloudletNodeRefs); i0++ {
		for i1 := 0; i1 < len(in.CloudletNodeRefs[i0].Nodes); i1++ {
		}
	}
	...
	for i0 := 0; i0 < len(in.ClusterInsts); i0++ {
		...
		for i2 := 0; i2 < len(in.ClusterInsts[i0].NodeResources.Gpus); i2++ {
		}
		for i1 := 0; i1 < len(in.ClusterInsts[i0].NodePools); i1++ {
			for i3 := 0; i3 < len(in.ClusterInsts[i0].NodePools[i1].NodeResources.Gpus); i3++ {
			}
		}
	}
	for i0 := 0; i0 < len(in.Apps); i0++ {
		...
		for i3 := 0; i3 < len(in.Apps[i0].KubernetesResources.CpuPool.TotalGpus); i3++ {
		}
		for i4 := 0; i4 < len(in.Apps[i0].KubernetesResources.CpuPool.Topology.MinNodeGpus); i4++ {
		}
		for i3 := 0; i3 < len(in.Apps[i0].KubernetesResources.GpuPool.TotalGpus); i3++ {
		}
		for i4 := 0; i4 < len(in.Apps[i0].KubernetesResources.GpuPool.Topology.MinNodeGpus); i4++ {
		}
		for i2 := 0; i2 < len(in.Apps[i0].NodeResources.Gpus); i2++ {
		}
		if _, found := tags["nocmp"]; found {
			in.Apps[i0].ObjId = ""
		}
	...
	for i0 := 0; i0 < len(in.AppInstances); i0++ {
		...
		for i3 := 0; i3 < len(in.AppInstances[i0].KubernetesResources.CpuPool.TotalGpus); i3++ {
		}
		for i4 := 0; i4 < len(in.AppInstances[i0].KubernetesResources.CpuPool.Topology.MinNodeGpus); i4++ {
		}
		for i3 := 0; i3 < len(in.AppInstances[i0].KubernetesResources.GpuPool.TotalGpus); i3++ {
		}
		for i4 := 0; i4 < len(in.AppInstances[i0].KubernetesResources.GpuPool.Topology.MinNodeGpus); i4++ {
		}
		for i2 := 0; i2 < len(in.AppInstances[i0].NodeResources.Gpus); i2++ {
		}
	}
	...
	for i0 := 0; i0 < len(in.VmPools); i0++ {
		for i1 := 0; i1 < len(in.VmPools[i0].Vms); i1++ {
			...
			for i3 := 0; i3 < len(in.VmPools[i0].Vms[i1].Flavor.Gpus); i3++ {
			}
		}
		if _, found := tags["nocmp"]; found {
...
var AllDataOptionalArgs = []string{
	...
	"platformfeatures:#.requirescontrolpool",
	"platformfeatures:#.supportsmultiplenodepools",
	"platformfeatures:#.managesk8scontrolnodes",
	"platformfeatures:#.usesingress",
	"platformfeatures:#.requiresgpudriver",
	"platformfeatures:#.usesrootlb",
	"platformfeatures:#.supportscloudletmanagedclusters",
	"platformfeatures:#.nodeusage",
	...
	"platformfeatures:#.resourcequotaproperties:#.type",
	...
	"zones:#.infraflavors:#.gpus:#.modelid",
	"zones:#.infraflavors:#.gpus:#.count",
	"zones:#.infraflavors:#.gpus:#.vendor",
	"zones:#.infraflavors:#.gpus:#.memory",
	"zones:#.infraflavors:#.gpus:#.inuse",
	"zones:#.infraflavors:#.limit",
	...
	"cloudlets:#.resourcequotas:#.resourcetype",
	...
	"cloudlets:#.infraflavors:#.gpus:#.modelid",
	"cloudlets:#.infraflavors:#.gpus:#.count",
	"cloudlets:#.infraflavors:#.gpus:#.vendor",
	"cloudlets:#.infraflavors:#.gpus:#.memory",
	"cloudlets:#.infraflavors:#.gpus:#.inuse",
	"cloudlets:#.infraflavors:#.limit",
	...
	"cloudletinfos:#.flavors:#.gpus:#.modelid",
	"cloudletinfos:#.flavors:#.gpus:#.count",
	"cloudletinfos:#.flavors:#.gpus:#.vendor",
	"cloudletinfos:#.flavors:#.gpus:#.memory",
	"cloudletinfos:#.flavors:#.gpus:#.inuse",
	"cloudletinfos:#.flavors:#.limit",
	...
	"cloudletinfos:#.resourcessnapshot.info:#.type",
	...
	"cloudletinfos:#.nodeinfos:#.gpus:#.modelid",
	"cloudletinfos:#.nodeinfos:#.gpus:#.count",
	"cloudletinfos:#.nodeinfos:#.gpus:#.vendor",
	"cloudletinfos:#.nodeinfos:#.gpus:#.memory",
	"cloudletinfos:#.nodeinfos:#.gpus:#.inuse",
	"cloudletinfos:#.nodeinfos:#.gpusoftware.driverversion",
	"cloudletinfos:#.nodeinfos:#.gpusoftware.runtimeversion",
	...
	"cloudletinfos:#.nodepools:#.noderesources.gpus:#.modelid",
	"cloudletinfos:#.nodepools:#.noderesources.gpus:#.count",
	"cloudletinfos:#.nodepools:#.noderesources.gpus:#.vendor",
	"cloudletinfos:#.nodepools:#.noderesources.gpus:#.memory",
	"cloudletinfos:#.nodepools:#.noderesources.gpus:#.inuse",
	...
	"cloudletinfos:#.nodepools:#.noderesources.nodename",
	"cloudletinfos:#.nodepools:#.scalable",
	"cloudletinfos:#.nodepools:#.controlplane",
	"cloudletinfos:#.nodepools:#.nodes",
	"zonepools:#.fields",
	...
	"nodes:#.fields",
	"nodes:#.key.organization",
	"nodes:#.key.name",
	"nodes:#.cloudletkey.organization",
	"nodes:#.cloudletkey.name",
	"nodes:#.cloudletkey.federatedorganization",
	"nodes:#.username",
	"nodes:#.publicaddr",
	"nodes:#.mgmtaddr",
	"nodes:#.sshport",
	"nodes:#.assignment",
	"nodes:#.health",
	"nodes:#.dynamicallycreated",
	"nodes:#.owner.name",
	"nodes:#.owner.organization",
	"nodes:#.noderesources.vcpus",
	"nodes:#.noderesources.ram",
	"nodes:#.noderesources.disk",
	"nodes:#.noderesources.gpus:#.modelid",
	"nodes:#.noderesources.gpus:#.count",
	"nodes:#.noderesources.gpus:#.vendor",
	"nodes:#.noderesources.gpus:#.memory",
	"nodes:#.noderesources.gpus:#.inuse",
	"nodes:#.noderesources.optresmap",
	"nodes:#.noderesources.infranodeflavor",
	"nodes:#.noderesources.externalvolumesize",
	"nodes:#.noderesources.nodename",
	"nodes:#.role",
	"nodes:#.nodepool",
	"nodes:#.flavorname",
	"nodes:#.skipnodecheck",
	"nodes:#.objid",
	"cloudletnoderefs:#.key.organization",
	"cloudletnoderefs:#.key.name",
	"cloudletnoderefs:#.key.federatedorganization",
	"cloudletnoderefs:#.nodes:#.organization",
	"cloudletnoderefs:#.nodes:#.name",
	"networks:#.fields",
	...
	"clusterinsts:#.noderesources.gpus:#.modelid",
	"clusterinsts:#.noderesources.gpus:#.count",
	"clusterinsts:#.noderesources.gpus:#.vendor",
	"clusterinsts:#.noderesources.gpus:#.memory",
	"clusterinsts:#.noderesources.gpus:#.inuse",
	...
	"clusterinsts:#.noderesources.nodename",
	...
	"clusterinsts:#.nodepools:#.noderesources.gpus:#.modelid",
	"clusterinsts:#.nodepools:#.noderesources.gpus:#.count",
	"clusterinsts:#.nodepools:#.noderesources.gpus:#.vendor",
	"clusterinsts:#.nodepools:#.noderesources.gpus:#.memory",
	"clusterinsts:#.nodepools:#.noderesources.gpus:#.inuse",
	...
	"clusterinsts:#.nodepools:#.noderesources.nodename",
	"clusterinsts:#.nodepools:#.scalable",
	"clusterinsts:#.nodepools:#.controlplane",
	"clusterinsts:#.nodepools:#.nodes",
	"clusterinsts:#.infraannotations",
	"clusterinsts:#.kubernetesversion",
	"clusterinsts:#.disabledynamicappinstplacement",
	"clusterinsts:#.cloudletmanagedclusterid",
	"clusterinsts:#.cloudletmanagedclustername",
	"clusterinsts:#.tags",
	"apps:#.fields",
	...
	"apps:#.kubernetesresources.cpupool.totalgpus:#.modelid",
	"apps:#.kubernetesresources.cpupool.totalgpus:#.count",
	"apps:#.kubernetesresources.cpupool.totalgpus:#.vendor",
	"apps:#.kubernetesresources.cpupool.totalgpus:#.memory",
	"apps:#.kubernetesresources.cpupool.totalgpus:#.inuse",
	...
	"apps:#.kubernetesresources.cpupool.topology.minnodegpus:#.modelid",
	"apps:#.kubernetesresources.cpupool.topology.minnodegpus:#.count",
	"apps:#.kubernetesresources.cpupool.topology.minnodegpus:#.vendor",
	"apps:#.kubernetesresources.cpupool.topology.minnodegpus:#.memory",
	"apps:#.kubernetesresources.cpupool.topology.minnodegpus:#.inuse",
	...
	"apps:#.kubernetesresources.gpupool.totalgpus:#.modelid",
	"apps:#.kubernetesresources.gpupool.totalgpus:#.count",
	"apps:#.kubernetesresources.gpupool.totalgpus:#.vendor",
	"apps:#.kubernetesresources.gpupool.totalgpus:#.memory",
	"apps:#.kubernetesresources.gpupool.totalgpus:#.inuse",
	...
	"apps:#.kubernetesresources.gpupool.topology.minnodegpus:#.modelid",
	"apps:#.kubernetesresources.gpupool.topology.minnodegpus:#.count",
	"apps:#.kubernetesresources.gpupool.topology.minnodegpus:#.vendor",
	"apps:#.kubernetesresources.gpupool.topology.minnodegpus:#.memory",
	"apps:#.kubernetesresources.gpupool.topology.minnodegpus:#.inuse",
	"apps:#.kubernetesresources.gpupool.topology.minnodeoptres",
	"apps:#.kubernetesresources.gpupool.topology.minnumberofnodes",
	"apps:#.kubernetesresources.minkubernetesversion",
	"apps:#.noderesources.vcpus",
	"apps:#.noderesources.ram",
	"apps:#.noderesources.disk",
	"apps:#.noderesources.gpus:#.modelid",
	"apps:#.noderesources.gpus:#.count",
	"apps:#.noderesources.gpus:#.vendor",
	"apps:#.noderesources.gpus:#.memory",
	"apps:#.noderesources.gpus:#.inuse",
	"apps:#.noderesources.optresmap",
	"apps:#.noderesources.infranodeflavor",
	"apps:#.noderesources.externalvolumesize",
	"apps:#.noderesources.nodename",
	"apps:#.objid",
	"apps:#.appannotations",
	"apps:#.isstandalone",
	...
	"appinstances:#.mappedports:#.internalvisonly",
	"appinstances:#.mappedports:#.id",
	"appinstances:#.mappedports:#.servicename",
	...
	"appinstances:#.kubernetesresources.cpupool.totalgpus:#.modelid",
	"appinstances:#.kubernetesresources.cpupool.totalgpus:#.count",
	"appinstances:#.kubernetesresources.cpupool.totalgpus:#.vendor",
	"appinstances:#.kubernetesresources.cpupool.totalgpus:#.memory",
	"appinstances:#.kubernetesresources.cpupool.totalgpus:#.inuse",
	...
	"appinstances:#.kubernetesresources.cpupool.topology.minnodegpus:#.modelid",
	"appinstances:#.kubernetesresources.cpupool.topology.minnodegpus:#.count",
	"appinstances:#.kubernetesresources.cpupool.topology.minnodegpus:#.vendor",
	"appinstances:#.kubernetesresources.cpupool.topology.minnodegpus:#.memory",
	"appinstances:#.kubernetesresources.cpupool.topology.minnodegpus:#.inuse",
	...
	"appinstances:#.kubernetesresources.gpupool.totalgpus:#.modelid",
	"appinstances:#.kubernetesresources.gpupool.totalgpus:#.count",
	"appinstances:#.kubernetesresources.gpupool.totalgpus:#.vendor",
	"appinstances:#.kubernetesresources.gpupool.totalgpus:#.memory",
	"appinstances:#.kubernetesresources.gpupool.totalgpus:#.inuse",
	...
	"appinstances:#.kubernetesresources.gpupool.topology.minnodegpus:#.modelid",
	"appinstances:#.kubernetesresources.gpupool.topology.minnodegpus:#.count",
	"appinstances:#.kubernetesresources.gpupool.topology.minnodegpus:#.vendor",
	"appinstances:#.kubernetesresources.gpupool.topology.minnodegpus:#.memory",
	"appinstances:#.kubernetesresources.gpupool.topology.minnodegpus:#.inuse",
	...
	"appinstances:#.kubernetesresources.minkubernetesversion",
	"appinstances:#.noderesources.vcpus",
	"appinstances:#.noderesources.ram",
	"appinstances:#.noderesources.disk",
	"appinstances:#.noderesources.gpus:#.modelid",
	"appinstances:#.noderesources.gpus:#.count",
	"appinstances:#.noderesources.gpus:#.vendor",
	"appinstances:#.noderesources.gpus:#.memory",
	"appinstances:#.noderesources.gpus:#.inuse",
	...
	"appinstances:#.noderesources.nodename",
	"appinstances:#.isstandalone",
	"appinstances:#.tags",
	...
	"vmpools:#.vms:#.flavor.gpus:#.modelid",
	"vmpools:#.vms:#.flavor.gpus:#.count",
	"vmpools:#.vms:#.flavor.gpus:#.vendor",
	"vmpools:#.vms:#.flavor.gpus:#.memory",
	"vmpools:#.vms:#.flavor.gpus:#.inuse",
	"vmpools:#.vms:#.flavor.limit",
...
var AllDataComments = map[string]string{
	...
	"platformfeatures:#.requirescontrolpool":                                     "Requires one of the kubernetes node pools to be a control plane",
	...
	"platformfeatures:#.requiresgpudriver":                                       "Platform requires GPU Driver to be managed by Edge Cloud for installation onto new VMs or nodes with the license provided by the operator.",
	"platformfeatures:#.usesrootlb":                                              "Platform users a shared root load balancer",
	"platformfeatures:#.supportscloudletmanagedclusters":                         "Platform supports cloudlet managed clusters",
	"platformfeatures:#.nodeusage":                                               "Set if the platform uses nodes as its base resource",
	...
	"platformfeatures:#.resourcequotaproperties:#.type":                          "Resource type category, i.e. gpu",
	...
	"zones:#.infraflavors:#.name":                                                "Name of the infra flavor",
	"zones:#.infraflavors:#.vcpus":                                               "Number of VCPU cores on the infra flavor",
	"zones:#.infraflavors:#.ram":                                                 "Ram in MB on the infra flavor",
	"zones:#.infraflavors:#.disk":                                                "Amount of disk in GB on the infra flavor",
	"zones:#.infraflavors:#.gpus:#.modelid":                                      "GPU model unique identifier",
	"zones:#.infraflavors:#.gpus:#.count":                                        "Count of how many of this GPU are required/present",
	"zones:#.infraflavors:#.gpus:#.vendor":                                       "GPU vendor (nvidia, amd, etc)",
	"zones:#.infraflavors:#.gpus:#.memory":                                       "Memory in GB",
	"zones:#.infraflavors:#.gpus:#.inuse":                                        "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	"zones:#.infraflavors:#.limit":                                               "Limit or quota on the number of this flavor that the platform provides",
	"zones:#.infraflavors:#.propmap":                                             "Infra flavor Properties, if any",
	...
	"cloudlets:#.resourcequotas:#.resourcetype":                                  "Resource type if non-generic resource, i.e. gpu",
	...
	"cloudlets:#.infraflavors:#.name":                                            "Name of the infra flavor",
	"cloudlets:#.infraflavors:#.vcpus":                                           "Number of VCPU cores on the infra flavor",
	"cloudlets:#.infraflavors:#.ram":                                             "Ram in MB on the infra flavor",
	"cloudlets:#.infraflavors:#.disk":                                            "Amount of disk in GB on the infra flavor",
	"cloudlets:#.infraflavors:#.gpus:#.modelid":                                  "GPU model unique identifier",
	"cloudlets:#.infraflavors:#.gpus:#.count":                                    "Count of how many of this GPU are required/present",
	"cloudlets:#.infraflavors:#.gpus:#.vendor":                                   "GPU vendor (nvidia, amd, etc)",
	"cloudlets:#.infraflavors:#.gpus:#.memory":                                   "Memory in GB",
	"cloudlets:#.infraflavors:#.gpus:#.inuse":                                    "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	"cloudlets:#.infraflavors:#.limit":                                           "Limit or quota on the number of this flavor that the platform provides",
	"cloudlets:#.infraflavors:#.propmap":                                         "Infra flavor Properties, if any",
	...
	"cloudletinfos:#.flavors:#.name":                                             "Name of the infra flavor",
	"cloudletinfos:#.flavors:#.vcpus":                                            "Number of VCPU cores on the infra flavor",
	"cloudletinfos:#.flavors:#.ram":                                              "Ram in MB on the infra flavor",
	"cloudletinfos:#.flavors:#.disk":                                             "Amount of disk in GB on the infra flavor",
	"cloudletinfos:#.flavors:#.gpus:#.modelid":                                   "GPU model unique identifier",
	"cloudletinfos:#.flavors:#.gpus:#.count":                                     "Count of how many of this GPU are required/present",
	"cloudletinfos:#.flavors:#.gpus:#.vendor":                                    "GPU vendor (nvidia, amd, etc)",
	"cloudletinfos:#.flavors:#.gpus:#.memory":                                    "Memory in GB",
	"cloudletinfos:#.flavors:#.gpus:#.inuse":                                     "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	"cloudletinfos:#.flavors:#.limit":                                            "Limit or quota on the number of this flavor that the platform provides",
	"cloudletinfos:#.flavors:#.propmap":                                          "Infra flavor Properties, if any",
	...
	"cloudletinfos:#.resourcessnapshot.info:#.type":                              "Resource type category, i.e. gpu",
	...
	"cloudletinfos:#.nodeinfos:#.gpus:#.modelid":                                 "GPU model unique identifier",
	"cloudletinfos:#.nodeinfos:#.gpus:#.count":                                   "Count of how many of this GPU are required/present",
	"cloudletinfos:#.nodeinfos:#.gpus:#.vendor":                                  "GPU vendor (nvidia, amd, etc)",
	"cloudletinfos:#.nodeinfos:#.gpus:#.memory":                                  "Memory in GB",
	"cloudletinfos:#.nodeinfos:#.gpus:#.inuse":                                   "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	"cloudletinfos:#.nodeinfos:#.gpusoftware.driverversion":                      "driver version",
	"cloudletinfos:#.nodeinfos:#.gpusoftware.runtimeversion":                     "Runtime version",
	...
	"cloudletinfos:#.nodepools:#.noderesources.gpus:#.modelid":                   "GPU model unique identifier",
	"cloudletinfos:#.nodepools:#.noderesources.gpus:#.count":                     "Count of how many of this GPU are required/present",
	"cloudletinfos:#.nodepools:#.noderesources.gpus:#.vendor":                    "GPU vendor (nvidia, amd, etc)",
	"cloudletinfos:#.nodepools:#.noderesources.gpus:#.memory":                    "Memory in GB",
	"cloudletinfos:#.nodepools:#.noderesources.gpus:#.inuse":                     "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	"cloudletinfos:#.nodepools:#.noderesources.optresmap":                        "Optional resources request, i.e. optresmap=restype=resname:1",
	...
	"cloudletinfos:#.nodepools:#.noderesources.nodename":                         "node name if using nodes as a resource",
	"cloudletinfos:#.nodepools:#.scalable":                                       "Scalable indicates the system may scale the number of nodes",
	"cloudletinfos:#.nodepools:#.controlplane":                                   "Pool is the control-plane pool for a Kubernetes cluster",
	"cloudletinfos:#.nodepools:#.nodes":                                          "Node names in pool when using nodes",
	...
	"nodes:#.key.organization":                                                   "Organization the node belongs to.",
	"nodes:#.key.name":                                                           "Name of the node",
	"nodes:#.cloudletkey.organization":                                           "Organization of the cloudlet site",
	"nodes:#.cloudletkey.name":                                                   "Name of the cloudlet",
	"nodes:#.cloudletkey.federatedorganization":                                  "Federated operator organization who shared this cloudlet",
	"nodes:#.username":                                                           "Username for accessing the node",
	"nodes:#.publicaddr":                                                         "Hostname or IP address of the public interface",
	"nodes:#.mgmtaddr":                                                           "Hostname or IP address of the management interface (defaults to public address)",
	"nodes:#.sshport":                                                            "SSH port on the management interface (defaults to 22)",
	"nodes:#.assignment":                                                         "Assignment status of node",
	"nodes:#.health":                                                             "Health status of node (set by system unless skip node check is set)",
	"nodes:#.dynamicallycreated":                                                 "Dynamically created is set to true if the node was created on-demand.",
	"nodes:#.owner.name":                                                         "Cluster name",
	"nodes:#.owner.organization":                                                 "Name of the organization that this cluster belongs to",
	"nodes:#.noderesources.vcpus":                                                "Vcpus to be allocated to the VM, must be either 1 or an even number",
	"nodes:#.noderesources.ram":                                                  "Total RAM in megabytes to be allocated to the VM",
	"nodes:#.noderesources.disk":                                                 "Total disk space in gigabytes to be allocated to the VMs root partition",
	"nodes:#.noderesources.gpus:#.modelid":                                       "GPU model unique identifier",
	"nodes:#.noderesources.gpus:#.count":                                         "Count of how many of this GPU are required/present",
	"nodes:#.noderesources.gpus:#.vendor":                                        "GPU vendor (nvidia, amd, etc)",
	"nodes:#.noderesources.gpus:#.memory":                                        "Memory in GB",
	"nodes:#.noderesources.gpus:#.inuse":                                         "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	"nodes:#.noderesources.optresmap":                                            "Optional resources request, i.e. optresmap=restype=resname:1",
	"nodes:#.noderesources.infranodeflavor":                                      "Infrastructure specific node flavor",
	"nodes:#.noderesources.externalvolumesize":                                   "Size of external volume to be attached to nodes. This is for the root partition",
	"nodes:#.noderesources.nodename":                                             "node name if using nodes as a resource",
	"nodes:#.role":                                                               "Node role in the context of the owning cluster",
	"nodes:#.nodepool":                                                           "Node pool assignment if applicable",
	"nodes:#.flavorname":                                                         "Name to use when represented as a flavor",
	"nodes:#.skipnodecheck":                                                      "Use on create/update to skip node checks, avoids ssh test",
	"nodes:#.objid":                                                              "Object ID",
	"cloudletnoderefs:#.key.organization":                                        "Organization of the cloudlet site",
	"cloudletnoderefs:#.key.name":                                                "Name of the cloudlet",
	"cloudletnoderefs:#.key.federatedorganization":                               "Federated operator organization who shared this cloudlet",
	"cloudletnoderefs:#.nodes:#.organization":                                    "Organization the node belongs to.",
	"cloudletnoderefs:#.nodes:#.name":                                            "Name of the node",
	...
	"clusterinsts:#.noderesources.gpus:#.modelid":                                "GPU model unique identifier",
	"clusterinsts:#.noderesources.gpus:#.count":                                  "Count of how many of this GPU are required/present",
	"clusterinsts:#.noderesources.gpus:#.vendor":                                 "GPU vendor (nvidia, amd, etc)",
	"clusterinsts:#.noderesources.gpus:#.memory":                                 "Memory in GB",
	"clusterinsts:#.noderesources.gpus:#.inuse":                                  "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	"clusterinsts:#.noderesources.optresmap":                                     "Optional resources request, i.e. optresmap=restype=resname:1",
	...
	"clusterinsts:#.noderesources.nodename":                                      "node name if using nodes as a resource",
	...
	"clusterinsts:#.nodepools:#.noderesources.gpus:#.modelid":                    "GPU model unique identifier",
	"clusterinsts:#.nodepools:#.noderesources.gpus:#.count":                      "Count of how many of this GPU are required/present",
	"clusterinsts:#.nodepools:#.noderesources.gpus:#.vendor":                     "GPU vendor (nvidia, amd, etc)",
	"clusterinsts:#.nodepools:#.noderesources.gpus:#.memory":                     "Memory in GB",
	"clusterinsts:#.nodepools:#.noderesources.gpus:#.inuse":                      "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	"clusterinsts:#.nodepools:#.noderesources.optresmap":                         "Optional resources request, i.e. optresmap=restype=resname:1",
	...
	"clusterinsts:#.nodepools:#.noderesources.nodename":                          "node name if using nodes as a resource",
	"clusterinsts:#.nodepools:#.scalable":                                        "Scalable indicates the system may scale the number of nodes",
	"clusterinsts:#.nodepools:#.controlplane":                                    "Pool is the control-plane pool for a Kubernetes cluster",
	"clusterinsts:#.nodepools:#.nodes":                                           "Node names in pool when using nodes",
	"clusterinsts:#.infraannotations":                                            "Annotations added by the implementing infrastructure",
	"clusterinsts:#.kubernetesversion":                                           "Kubernetes version of cluster if applicable",
	"clusterinsts:#.disabledynamicappinstplacement":                              "Disables dynamic placement of AppInsts on this cluster",
	"clusterinsts:#.cloudletmanagedclusterid":                                    "Cloudlet managed cluster ID, if cluster based on cloudlet managed cluster",
	"clusterinsts:#.cloudletmanagedclustername":                                  "Cloudlet managed cluster name, if cluster based on cloudlet managed cluster",
	"clusterinsts:#.tags":                                                        "Vendor-specific data",
	...
	"apps:#.kubernetesresources.cpupool.totalgpus:#.modelid":                     "GPU model unique identifier",
	"apps:#.kubernetesresources.cpupool.totalgpus:#.count":                       "Count of how many of this GPU are required/present",
	"apps:#.kubernetesresources.cpupool.totalgpus:#.vendor":                      "GPU vendor (nvidia, amd, etc)",
	"apps:#.kubernetesresources.cpupool.totalgpus:#.memory":                      "Memory in GB",
	"apps:#.kubernetesresources.cpupool.totalgpus:#.inuse":                       "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	...
	"apps:#.kubernetesresources.cpupool.topology.minnodegpus:#.modelid":          "GPU model unique identifier",
	"apps:#.kubernetesresources.cpupool.topology.minnodegpus:#.count":            "Count of how many of this GPU are required/present",
	"apps:#.kubernetesresources.cpupool.topology.minnodegpus:#.vendor":           "GPU vendor (nvidia, amd, etc)",
	"apps:#.kubernetesresources.cpupool.topology.minnodegpus:#.memory":           "Memory in GB",
	"apps:#.kubernetesresources.cpupool.topology.minnodegpus:#.inuse":            "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	...
	"apps:#.kubernetesresources.gpupool.totalgpus:#.modelid":                     "GPU model unique identifier",
	"apps:#.kubernetesresources.gpupool.totalgpus:#.count":                       "Count of how many of this GPU are required/present",
	"apps:#.kubernetesresources.gpupool.totalgpus:#.vendor":                      "GPU vendor (nvidia, amd, etc)",
	"apps:#.kubernetesresources.gpupool.totalgpus:#.memory":                      "Memory in GB",
	"apps:#.kubernetesresources.gpupool.totalgpus:#.inuse":                       "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	...
	"apps:#.kubernetesresources.gpupool.topology.minnodegpus:#.modelid":          "GPU model unique identifier",
	"apps:#.kubernetesresources.gpupool.topology.minnodegpus:#.count":            "Count of how many of this GPU are required/present",
	"apps:#.kubernetesresources.gpupool.topology.minnodegpus:#.vendor":           "GPU vendor (nvidia, amd, etc)",
	"apps:#.kubernetesresources.gpupool.topology.minnodegpus:#.memory":           "Memory in GB",
	"apps:#.kubernetesresources.gpupool.topology.minnodegpus:#.inuse":            "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	...
	"apps:#.kubernetesresources.minkubernetesversion":                            "Minimum Kubernetes version",
	...
	"apps:#.noderesources.gpus:#.modelid":                                        "GPU model unique identifier",
	"apps:#.noderesources.gpus:#.count":                                          "Count of how many of this GPU are required/present",
	"apps:#.noderesources.gpus:#.vendor":                                         "GPU vendor (nvidia, amd, etc)",
	"apps:#.noderesources.gpus:#.memory":                                         "Memory in GB",
	"apps:#.noderesources.gpus:#.inuse":                                          "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	"apps:#.noderesources.optresmap":                                             "Optional resources request, i.e. optresmap=restype=resname:1",
	...
	"apps:#.noderesources.nodename":                                              "node name if using nodes as a resource",
	...
	"appinstances:#.mappedports:#.proto":                                         "TCP (L4) or UDP (L4) protocol, one of Unknown, Tcp, Udp, Http",
	...
	"appinstances:#.mappedports:#.pathprefix":                                    "PathPrefix for HTTP ports in Kubernetes ingress",
	...
	"appinstances:#.kubernetesresources.cpupool.totalgpus:#.modelid":             "GPU model unique identifier",
	"appinstances:#.kubernetesresources.cpupool.totalgpus:#.count":               "Count of how many of this GPU are required/present",
	"appinstances:#.kubernetesresources.cpupool.totalgpus:#.vendor":              "GPU vendor (nvidia, amd, etc)",
	"appinstances:#.kubernetesresources.cpupool.totalgpus:#.memory":              "Memory in GB",
	"appinstances:#.kubernetesresources.cpupool.totalgpus:#.inuse":               "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	...
	"appinstances:#.kubernetesresources.cpupool.topology.minnodegpus:#.modelid":  "GPU model unique identifier",
	"appinstances:#.kubernetesresources.cpupool.topology.minnodegpus:#.count":    "Count of how many of this GPU are required/present",
	"appinstances:#.kubernetesresources.cpupool.topology.minnodegpus:#.vendor":   "GPU vendor (nvidia, amd, etc)",
	"appinstances:#.kubernetesresources.cpupool.topology.minnodegpus:#.memory":   "Memory in GB",
	"appinstances:#.kubernetesresources.cpupool.topology.minnodegpus:#.inuse":    "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	...
	"appinstances:#.kubernetesresources.gpupool.totalgpus:#.modelid":             "GPU model unique identifier",
	"appinstances:#.kubernetesresources.gpupool.totalgpus:#.count":               "Count of how many of this GPU are required/present",
	"appinstances:#.kubernetesresources.gpupool.totalgpus:#.vendor":              "GPU vendor (nvidia, amd, etc)",
	"appinstances:#.kubernetesresources.gpupool.totalgpus:#.memory":              "Memory in GB",
	"appinstances:#.kubernetesresources.gpupool.totalgpus:#.inuse":               "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	...
	"appinstances:#.kubernetesresources.gpupool.topology.minnodegpus:#.modelid":  "GPU model unique identifier",
	"appinstances:#.kubernetesresources.gpupool.topology.minnodegpus:#.count":    "Count of how many of this GPU are required/present",
	"appinstances:#.kubernetesresources.gpupool.topology.minnodegpus:#.vendor":   "GPU vendor (nvidia, amd, etc)",
	"appinstances:#.kubernetesresources.gpupool.topology.minnodegpus:#.memory":   "Memory in GB",
	"appinstances:#.kubernetesresources.gpupool.topology.minnodegpus:#.inuse":    "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	...
	"appinstances:#.kubernetesresources.minkubernetesversion":                    "Minimum Kubernetes version",
	...
	"appinstances:#.noderesources.gpus:#.modelid":                                "GPU model unique identifier",
	"appinstances:#.noderesources.gpus:#.count":                                  "Count of how many of this GPU are required/present",
	"appinstances:#.noderesources.gpus:#.vendor":                                 "GPU vendor (nvidia, amd, etc)",
	"appinstances:#.noderesources.gpus:#.memory":                                 "Memory in GB",
	"appinstances:#.noderesources.gpus:#.inuse":                                  "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	"appinstances:#.noderesources.optresmap":                                     "Optional resources request, i.e. optresmap=restype=resname:1",
	...
	"appinstances:#.noderesources.nodename":                                      "node name if using nodes as a resource",
	"appinstances:#.isstandalone":                                                "A standalone AppInst will not share a cluster with another AppInst unless explicitly targeted to the same cluster",
	"appinstances:#.tags":                                                        "Vendor-specific data",
	...
	"vmpools:#.vms:#.flavor.name":                                                "Name of the infra flavor",
	"vmpools:#.vms:#.flavor.vcpus":                                               "Number of VCPU cores on the infra flavor",
	"vmpools:#.vms:#.flavor.ram":                                                 "Ram in MB on the infra flavor",
	"vmpools:#.vms:#.flavor.disk":                                                "Amount of disk in GB on the infra flavor",
	"vmpools:#.vms:#.flavor.gpus:#.modelid":                                      "GPU model unique identifier",
	"vmpools:#.vms:#.flavor.gpus:#.count":                                        "Count of how many of this GPU are required/present",
	"vmpools:#.vms:#.flavor.gpus:#.vendor":                                       "GPU vendor (nvidia, amd, etc)",
	"vmpools:#.vms:#.flavor.gpus:#.memory":                                       "Memory in GB",
	"vmpools:#.vms:#.flavor.gpus:#.inuse":                                        "Read-only indication of how many GPUs are in use by tenants for usage APIs",
	"vmpools:#.vms:#.flavor.limit":                                               "Limit or quota on the number of this flavor that the platform provides",
	"vmpools:#.vms:#.flavor.propmap":                                             "Infra flavor Properties, if any",
...
var AllDataSpecialArgs = map[string]string{
	...
	"appinstances:#.tags":     "StringToString",
	"apps:#.alertpolicies":    "StringArray",
	"apps:#.appannotations":   "StringToString",
	...
	"cloudletinfos:#.nodepools:#.nodes":                         "StringArray",
	...
	"nodes:#.noderesources.optresmap":                           "StringToString",
