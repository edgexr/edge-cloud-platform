...
var AllDataComments = map[string]string{
	...
	"clusterinsts:#.externalvolumesize":                                          "(_deprecated_) Replaced by NodePools.ExternalVolumeSize. Size of external volume to be attached to nodes. This is for the root partition",
