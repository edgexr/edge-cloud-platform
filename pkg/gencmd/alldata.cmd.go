...
var AllDataOptionalArgs = []string{
	...
	"clusterinsts:#.key.clusterkey.organization",
	...
	"appinstances:#.key.cloudletkey.organization",
	"appinstances:#.key.cloudletkey.name",
	"appinstances:#.key.cloudletkey.federatedorganization",
	...
	"clusterrefs:#.key.clusterkey.organization",
...
var AllDataComments = map[string]string{
	...
	"cloudletinfos:#.resourcessnapshot.vmappinsts:#.name":                        "AppInst name",
	"cloudletinfos:#.resourcessnapshot.vmappinsts:#.organization":                "AppInst organization",
	"cloudletinfos:#.resourcessnapshot.k8sappinsts:#.name":                       "AppInst name",
	"cloudletinfos:#.resourcessnapshot.k8sappinsts:#.organization":               "AppInst organization",
	...
	"clusterinsts:#.key.clusterkey.organization":                                 "Name of the organization that this cluster belongs to",
	...
	"appinstances:#.key.cloudletkey.organization":                                "Organization of the cloudlet site",
	"appinstances:#.key.cloudletkey.name":                                        "Name of the cloudlet",
	"appinstances:#.key.cloudletkey.federatedorganization":                       "Federated operator organization who shared this cloudlet",
	...
	"appinstances:#.cloudletflavor":                                              "Cloudlet-specific flavor instead of regional flavor",
	...
	"clusterrefs:#.key.clusterkey.organization":                                  "Name of the organization that this cluster belongs to",
	...
	"clusterrefs:#.apps:#.name":                                                  "AppInst name",
	"clusterrefs:#.apps:#.organization":                                          "AppInst organization",
