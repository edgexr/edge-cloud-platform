...
var AppInstClientOptionalArgs = []string{
	...
	"clientkey.appinstkey.cloudletkey.organization",
	"clientkey.appinstkey.cloudletkey.name",
	"clientkey.appinstkey.cloudletkey.federatedorganization",
	"clientkey.appkey.organization",
	"clientkey.appkey.name",
	"clientkey.appkey.version",
	"clientkey.clusterkey.name",
	"clientkey.clusterkey.organization",
	"clientkey.uniqueid",
...
var AppInstClientComments = map[string]string{
	...
	"clientkey.appinstkey.cloudletkey.organization":          "Organization of the cloudlet site",
	"clientkey.appinstkey.cloudletkey.name":                  "Name of the cloudlet",
	"clientkey.appinstkey.cloudletkey.federatedorganization": "Federated operator organization who shared this cloudlet",
	...
	"clientkey.clusterkey.name":                              "Cluster name",
	"clientkey.clusterkey.organization":                      "Name of the organization that this cluster belongs to",
