...
var AppComments = map[string]string{
	...
	"username":                               "Username for authenticating to a private image registry",
	"credentials":                            "Credentials for authenticating to a private image registry, saved in encrypted storage",
...
var DeploymentZoneRequestComments = map[string]string{
	...
	"appname":                 "App name",
	"appvers":                 "App version",
	"app.imagepath":           "URI of where image resides. For container images, this may be a path on docker hub, i.e. nginx:latest or nginx/nginx-ingress:5.2-alpine, or a full path like ghcr.io/cloudnative-pg/postgresql:14.9. For helm charts, the format is either https://<helm-repo>:<repo-name>/<chart-name>, i.e. https://charts.bitnami.com/bitnami:bitnami/redis, or an OCI path, i.e. oci://ghcr.io/company/chart. Note for Helm the chart version goes on the App Annotations field, i.e. version=1.2.3,wait=true,timeout=60. For VM images, this should be an http(s) URL to the image file.",
	...
	"app.username":            "Username for authenticating to a private image registry",
	"app.credentials":         "Credentials for authenticating to a private image registry, saved in encrypted storage",
