...
var ClusterInstComments = map[string]string{
	...
	"nodepools:#.nodes":                            "Node names in pool when using nodes, specify nodepools:#.nodes:empty=true to clear",
...
var ClusterInstInfoComments = map[string]string{
	...
	"cloudletmanagedclusterinfo.nodepools:#.noderesources.nodename":           "node name if using nodes as a resource",
	...
	"cloudletmanagedclusterinfo.nodepools:#.nodes":                            "Node names in pool when using nodes",
