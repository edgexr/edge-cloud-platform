...
var ClusterInstComments = map[string]string{
	...
	"nodepools:#.nodes":                            "Node names in pool when using site nodes, specify nodepools:#.nodes:empty=true to clear",
...
var ClusterInstInfoOptionalArgs = []string{
	...
	"cloudletmanagedclusterinfo.nodepools:#.noderesources.nodename",
	"cloudletmanagedclusterinfo.nodepools:#.scalable",
	"cloudletmanagedclusterinfo.nodepools:#.controlplane",
	"cloudletmanagedclusterinfo.nodepools:#.nodes",
	"infraannotations",
}
...
var ClusterInstInfoComments = map[string]string{
	...
	"cloudletmanagedclusterinfo.nodepools:#.noderesources.nodename":           "Site node name if using site nodes",
	"cloudletmanagedclusterinfo.nodepools:#.scalable":                         "Scalable indicates the system may scale the number of nodes",
	"cloudletmanagedclusterinfo.nodepools:#.controlplane":                     "Pool is the control-plane pool for a Kubernetes cluster",
	"cloudletmanagedclusterinfo.nodepools:#.nodes":                            "Node names in pool when using site nodes",
...
var ClusterInstInfoSpecialArgs = map[string]string{
	...
	"cloudletmanagedclusterinfo.nodepools:#.nodes":                   "StringArray",
	"errors":           "StringArray",
	"fields":           "StringArray",
	"infraannotations": "StringToString",
