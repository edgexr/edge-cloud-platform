...
var ClusterInstComments = map[string]string{
	...
	"nodeflavor":                        "(_deprecated_) Replaced by NodePools.CloudletNodeFlavor. Cloudlet specific node flavor.",
	...
	"numnodes":                          "(_deprecated_) Replaced by NodePools.NumNodes. Number of k8s nodes (In case of docker deployment, this field is not required)",
	"externalvolumesize":                "(_deprecated_) Replaced by NodePools.ExternalVolumeSize. Size of external volume to be attached to nodes. This is for the root partition",
