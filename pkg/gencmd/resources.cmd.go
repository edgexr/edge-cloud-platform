...
var KubernetesResourcesComments = map[string]string{
	...
	"cpupool.topology.minnodecpus":      "Minimum number of vcpus per node",
	...
	"gpupool.topology.minnodecpus":      "Minimum number of vcpus per node",
...
var NodePoolResourcesComments = map[string]string{
	...
	"topology.minnodecpus":      "Minimum number of vcpus per node",
...
var NodePoolTopologyComments = map[string]string{
	"minnodecpus":      "Minimum number of vcpus per node",
