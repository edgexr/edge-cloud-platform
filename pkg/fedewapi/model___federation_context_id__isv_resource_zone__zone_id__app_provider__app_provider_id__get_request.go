...
func NewFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest(appProviderId string, zoneId string, poolId string, grantedFlavours []FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestGrantedFlavoursInner) *FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest {
