...
func (s *FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest) Validate() error {
	...
	if !FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestFederationContextIdRE.MatchString(s.FederationContextId) {
		return errors.New("federationContextId " + s.FederationContextId + " does not match format " + FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestFederationContextIdPattern)
	}
	if s.ZoneId == "" {
		return errors.New("zoneId is required")
	}
	if !FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestZoneIdRE.MatchString(s.ZoneId) {
		return errors.New("zoneId " + s.ZoneId + " does not match format " + FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestZoneIdPattern)
	}
	if s.AppProviderId == "" {
		return errors.New("appProviderId is required")
	}
	if !FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestAppProviderIdRE.MatchString(s.AppProviderId) {
		return errors.New("appProviderId " + s.AppProviderId + " does not match format " + FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestAppProviderIdPattern)
	}
	if s.PoolId == "" {
		return errors.New("poolId is required")
	}
	if !FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestPoolIdRE.MatchString(s.PoolId) {
		return errors.New("poolId " + s.PoolId + " does not match format " + FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestPoolIdPattern)
	}
	for ii := range s.GrantedFlavours {
		if err := s.GrantedFlavours[ii].Validate(); err != nil {
			return err
		}
	}
	return nil
...
// NewFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest instantiates a new FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest object
...
// NewFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestWithDefaults instantiates a new FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest object
...
func (o *FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest) GetGrantedFlavours() []FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestGrantedFlavoursInner {
	if o == nil {
		var ret []FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestGrantedFlavoursInner
		return ret
	}

	return o.GrantedFlavours
}

// GetGrantedFlavoursOk returns a tuple with the GrantedFlavours field value
// and a boolean to check if the value has been set.
func (o *FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest) GetGrantedFlavoursOk() ([]FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestGrantedFlavoursInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.GrantedFlavours, true
}

// SetGrantedFlavours sets field value
func (o *FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest) SetGrantedFlavours(v []FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequestGrantedFlavoursInner) {
	o.GrantedFlavours = v
}
...
type NullableFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest struct {
	value *FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest
	isSet bool
}

func (v NullableFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest) Get() *FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest {
	return v.value
}

func (v *NullableFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest) Set(val *FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest(val *FederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest) *NullableFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest {
	return &NullableFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest{value: val, isSet: true}
}

func (v NullableFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFederationContextIdIsvResourceZoneZoneIdAppProviderAppProviderIdGetRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
