...
// checks if the AppQoSProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppQoSProfile{}
...
func (s *AppQoSProfile) Validate() error {
...
// NewAppQoSProfile instantiates a new AppQoSProfile object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAppQoSProfile(latencyConstraints string) *AppQoSProfile {
	this := AppQoSProfile{}
...
// NewAppQoSProfileWithDefaults instantiates a new AppQoSProfile object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAppQoSProfileWithDefaults() *AppQoSProfile {
	this := AppQoSProfile{}
	var multiUserClients string = "APP_TYPE_SINGLE_USER"
	this.MultiUserClients = &multiUserClients
	var noOfUsersPerAppInst int32 = 1
...
func (o *AppQoSProfile) GetLatencyConstraints() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *AppQoSProfile) GetLatencyConstraintsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *AppQoSProfile) GetBandwidthRequiredOk() (*int32, bool) {
	if o == nil || isNil(o.BandwidthRequired) {
		return nil, false
	}
...
func (o *AppQoSProfile) HasBandwidthRequired() bool {
	if o != nil && !isNil(o.BandwidthRequired) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *AppQoSProfile) GetMultiUserClientsOk() (*string, bool) {
	if o == nil || isNil(o.MultiUserClients) {
		return nil, false
	}
...
func (o *AppQoSProfile) HasMultiUserClients() bool {
	if o != nil && !isNil(o.MultiUserClients) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *AppQoSProfile) GetNoOfUsersPerAppInstOk() (*int32, bool) {
	if o == nil || isNil(o.NoOfUsersPerAppInst) {
		return nil, false
	}
...
func (o *AppQoSProfile) HasNoOfUsersPerAppInst() bool {
	if o != nil && !isNil(o.NoOfUsersPerAppInst) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *AppQoSProfile) GetAppProvisioningOk() (*bool, bool) {
	if o == nil || isNil(o.AppProvisioning) {
		return nil, false
	}
...
func (o *AppQoSProfile) HasAppProvisioning() bool {
	if o != nil && !isNil(o.AppProvisioning) {
		return true
	}
...
func (o *AppQoSProfile) SetAppProvisioning(v bool) {
	o.AppProvisioning = &v
}

func (o AppQoSProfile) MarshalJSON() ([]byte, error) {
...
func (o AppQoSProfile) ToMap() (map[string]interface{}, error) {
...
type NullableAppQoSProfile struct {
	value *AppQoSProfile
	isSet bool
}

func (v NullableAppQoSProfile) Get() *AppQoSProfile {
	return v.value
}

func (v *NullableAppQoSProfile) Set(val *AppQoSProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableAppQoSProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableAppQoSProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppQoSProfile(val *AppQoSProfile) *NullableAppQoSProfile {
	return &NullableAppQoSProfile{value: val, isSet: true}
}

func (v NullableAppQoSProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppQoSProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
