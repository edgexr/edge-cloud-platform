...
type ViewISVResPool200Response struct {
	...
	ReservedFlavours []ViewISVResPool200ResponseReservedFlavoursInner `json:"reservedFlavours"`
...
// NewViewISVResPool200Response instantiates a new ViewISVResPool200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewViewISVResPool200Response(poolName string, reservedPoolId string, reservedFlavours []ViewISVResPool200ResponseReservedFlavoursInner) *ViewISVResPool200Response {
	this := ViewISVResPool200Response{}
...
// NewViewISVResPool200ResponseWithDefaults instantiates a new ViewISVResPool200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewViewISVResPool200ResponseWithDefaults() *ViewISVResPool200Response {
	this := ViewISVResPool200Response{}
	return &this
}

// GetPoolName returns the PoolName field value
func (o *ViewISVResPool200Response) GetPoolName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ViewISVResPool200Response) GetPoolNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ViewISVResPool200Response) SetPoolName(v string) {
	o.PoolName = v
}

// GetReservedPoolId returns the ReservedPoolId field value
func (o *ViewISVResPool200Response) GetReservedPoolId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ViewISVResPool200Response) GetReservedPoolIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ViewISVResPool200Response) SetReservedPoolId(v string) {
	o.ReservedPoolId = v
}

// GetReservedFlavours returns the ReservedFlavours field value
func (o *ViewISVResPool200Response) GetReservedFlavours() []ViewISVResPool200ResponseReservedFlavoursInner {
	if o == nil {
		var ret []ViewISVResPool200ResponseReservedFlavoursInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ViewISVResPool200Response) GetReservedFlavoursOk() ([]ViewISVResPool200ResponseReservedFlavoursInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ViewISVResPool200Response) SetReservedFlavours(v []ViewISVResPool200ResponseReservedFlavoursInner) {
...
func (o *ViewISVResPool200Response) SetReserveDuration(v ResourceReservationDuration) {
	o.ReserveDuration = &v
}
...
func (o *ViewISVResPool200Response) SetReservationTime(v time.Time) {
	o.ReservationTime = &v
}
...
type NullableViewISVResPool200Response struct {
	value *ViewISVResPool200Response
	isSet bool
}

func (v NullableViewISVResPool200Response) Get() *ViewISVResPool200Response {
	return v.value
}

func (v *NullableViewISVResPool200Response) Set(val *ViewISVResPool200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableViewISVResPool200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableViewISVResPool200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewISVResPool200Response(val *ViewISVResPool200Response) *NullableViewISVResPool200Response {
	return &NullableViewISVResPool200Response{value: val, isSet: true}
}

func (v NullableViewISVResPool200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewISVResPool200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
