...
func (s *ViewFile200Response) Validate() error {
	if s.FileId == "" {
	...
	if !ViewFile200ResponseAppProviderIdRE.MatchString(s.AppProviderId) {
		return errors.New("appProviderId " + s.AppProviderId + " does not match format " + ViewFile200ResponseAppProviderIdPattern)
	}
	if s.FileName == "" {
		return errors.New("fileName is required")
	}
	if !ViewFile200ResponseFileNameRE.MatchString(s.FileName) {
		return errors.New("fileName " + s.FileName + " does not match format " + ViewFile200ResponseFileNamePattern)
	}
...
func (o *ViewFile200Response) HasFileRepoLocation() bool {
	if o != nil && !isNil(o.FileRepoLocation) {
		return true
	}
