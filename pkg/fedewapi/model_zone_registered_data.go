...
func (s *ZoneRegisteredData) Validate() error {
	...
	if !ZoneRegisteredDataZoneIdRE.MatchString(s.ZoneId) {
		return errors.New("zoneId " + s.ZoneId + " does not match format " + ZoneRegisteredDataZoneIdPattern)
	}
	for ii := range s.ReservedComputeResources {
		if err := s.ReservedComputeResources[ii].Validate(); err != nil {
			return err
		}
	}
	for ii := range s.ComputeResourceQuotaLimits {
		if err := s.ComputeResourceQuotaLimits[ii].Validate(); err != nil {
			return err
		}
	}
	for ii := range s.FlavoursSupported {
		if err := s.FlavoursSupported[ii].Validate(); err != nil {
			return err
		}
	}
	if s.NetworkResources != nil {
		if err := s.NetworkResources.Validate(); err != nil {
			return err
		}
	}
	return nil
...
func NewZoneRegisteredData(zoneId string, reservedComputeResources []ComputeResourceInfo, computeResourceQuotaLimits []ComputeResourceInfo, flavoursSupported []Flavour) *ZoneRegisteredData {
...
// GetReservedComputeResources returns the ReservedComputeResources field value
...
// GetReservedComputeResourcesOk returns a tuple with the ReservedComputeResources field value
// and a boolean to check if the value has been set.
...
// SetReservedComputeResources sets field value
func (o *ZoneRegisteredData) SetReservedComputeResources(v []ComputeResourceInfo) {
	o.ReservedComputeResources = v
}

// GetComputeResourceQuotaLimits returns the ComputeResourceQuotaLimits field value
...
// GetComputeResourceQuotaLimitsOk returns a tuple with the ComputeResourceQuotaLimits field value
// and a boolean to check if the value has been set.
...
// SetComputeResourceQuotaLimits sets field value
