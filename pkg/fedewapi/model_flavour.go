...
func (s *Flavour) Validate() error {
	if s.FlavourId == "" {
		return errors.New("flavourId is required")
	}
	for ii := range s.SupportedOSTypes {
		if err := s.SupportedOSTypes[ii].Validate(); err != nil {
			return err
		}
	}
	for ii := range s.Gpu {
...
// and a boolean to check if the value has been set.
func (o *Flavour) GetFpgaOk() (*int32, bool) {
	if o == nil || isNil(o.Fpga) {
		return nil, false
	}
	return o.Fpga, true
...
func (o *Flavour) SetFpga(v int32) {
	o.Fpga = &v
}
