...
type InstallAppRequest struct {
	...
	ZoneInfo            InstallAppRequestZoneInfo `json:"zoneInfo"`
...
func (s *InstallAppRequest) Validate() error {
	if s.AppInstanceId == "" {
		return errors.New("appInstanceId is required")
	}
	if !InstallAppRequestAppInstanceIdRE.MatchString(s.AppInstanceId) {
		return errors.New("appInstanceId " + s.AppInstanceId + " does not match format " + InstallAppRequestAppInstanceIdPattern)
	}
	if s.AppId == "" {
		return errors.New("appId is required")
	}
	if !InstallAppRequestAppIdRE.MatchString(s.AppId) {
		return errors.New("appId " + s.AppId + " does not match format " + InstallAppRequestAppIdPattern)
	}
	if s.AppVersion == "" {
	...
	if !InstallAppRequestAppProviderIdRE.MatchString(s.AppProviderId) {
		return errors.New("appProviderId " + s.AppProviderId + " does not match format " + InstallAppRequestAppProviderIdPattern)
	}
	if err := s.ZoneInfo.Validate(); err != nil {
		return err
	}
	if s.AppInstCallbackLink == "" {
		return errors.New("appInstCallbackLink is required")
	}
	return nil
}

// NewInstallAppRequest instantiates a new InstallAppRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInstallAppRequest(appInstanceId string, appId string, appVersion string, appProviderId string, zoneInfo InstallAppRequestZoneInfo, appInstCallbackLink string) *InstallAppRequest {
	this := InstallAppRequest{}
	this.AppInstanceId = appInstanceId
	this.AppId = appId
	this.AppVersion = appVersion
	this.AppProviderId = appProviderId
	this.ZoneInfo = zoneInfo
	this.AppInstCallbackLink = appInstCallbackLink
	return &this
}

// NewInstallAppRequestWithDefaults instantiates a new InstallAppRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInstallAppRequestWithDefaults() *InstallAppRequest {
	this := InstallAppRequest{}
	return &this
}

// GetAppInstanceId returns the AppInstanceId field value
func (o *InstallAppRequest) GetAppInstanceId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InstallAppRequest) GetAppInstanceIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InstallAppRequest) SetAppInstanceId(v string) {
	o.AppInstanceId = v
}
...
// and a boolean to check if the value has been set.
func (o *InstallAppRequest) GetAppIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.AppId, true
...
func (o *InstallAppRequest) SetAppId(v string) {
	o.AppId = v
}

// GetAppVersion returns the AppVersion field value
func (o *InstallAppRequest) GetAppVersion() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InstallAppRequest) GetAppVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InstallAppRequest) SetAppVersion(v string) {
	o.AppVersion = v
}

// GetAppProviderId returns the AppProviderId field value
func (o *InstallAppRequest) GetAppProviderId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InstallAppRequest) GetAppProviderIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InstallAppRequest) SetAppProviderId(v string) {
	o.AppProviderId = v
}

// GetZoneInfo returns the ZoneInfo field value
func (o *InstallAppRequest) GetZoneInfo() InstallAppRequestZoneInfo {
	if o == nil {
		var ret InstallAppRequestZoneInfo
		return ret
	}
...
// GetZoneInfoOk returns a tuple with the ZoneInfo field value
// and a boolean to check if the value has been set.
func (o *InstallAppRequest) GetZoneInfoOk() (*InstallAppRequestZoneInfo, bool) {
	if o == nil {
		return nil, false
	}
...
// SetZoneInfo sets field value
func (o *InstallAppRequest) SetZoneInfo(v InstallAppRequestZoneInfo) {
	o.ZoneInfo = v
}

// GetAppInstCallbackLink returns the AppInstCallbackLink field value
func (o *InstallAppRequest) GetAppInstCallbackLink() string {
	if o == nil {
		var ret string
		return ret
	}

	return o.AppInstCallbackLink
}

// GetAppInstCallbackLinkOk returns a tuple with the AppInstCallbackLink field value
// and a boolean to check if the value has been set.
func (o *InstallAppRequest) GetAppInstCallbackLinkOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.AppInstCallbackLink, true
}

// SetAppInstCallbackLink sets field value
func (o *InstallAppRequest) SetAppInstCallbackLink(v string) {
	o.AppInstCallbackLink = v
}
...
type NullableInstallAppRequest struct {
	value *InstallAppRequest
	isSet bool
}

func (v NullableInstallAppRequest) Get() *InstallAppRequest {
	return v.value
}

func (v *NullableInstallAppRequest) Set(val *InstallAppRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableInstallAppRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableInstallAppRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstallAppRequest(val *InstallAppRequest) *NullableInstallAppRequest {
	return &NullableInstallAppRequest{value: val, isSet: true}
}

func (v NullableInstallAppRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstallAppRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
