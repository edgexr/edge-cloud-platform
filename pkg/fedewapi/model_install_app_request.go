...
func NewInstallAppRequest(appId string, appVersion string, appProviderId string, zoneInfo InstallAppRequestZoneInfo, appInstCallbackLink string) *InstallAppRequest {
