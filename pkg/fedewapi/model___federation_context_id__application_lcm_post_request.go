...
func (s *FederationContextIdApplicationLcmPostRequest) Validate() error {
	...
	if !FederationContextIdApplicationLcmPostRequestFederationContextIdRE.MatchString(s.FederationContextId) {
		return errors.New("federationContextId " + s.FederationContextId + " does not match format " + FederationContextIdApplicationLcmPostRequestFederationContextIdPattern)
	}
	if s.AppId == "" {
		return errors.New("appId is required")
	}
	if !FederationContextIdApplicationLcmPostRequestAppIdRE.MatchString(s.AppId) {
		return errors.New("appId " + s.AppId + " does not match format " + FederationContextIdApplicationLcmPostRequestAppIdPattern)
	}
	if s.AppInstanceId == "" {
		return errors.New("appInstanceId is required")
	}
	if !FederationContextIdApplicationLcmPostRequestAppInstanceIdRE.MatchString(s.AppInstanceId) {
		return errors.New("appInstanceId " + s.AppInstanceId + " does not match format " + FederationContextIdApplicationLcmPostRequestAppInstanceIdPattern)
	}
	if s.ZoneId == "" {
		return errors.New("zoneId is required")
	}
	if !FederationContextIdApplicationLcmPostRequestZoneIdRE.MatchString(s.ZoneId) {
		return errors.New("zoneId " + s.ZoneId + " does not match format " + FederationContextIdApplicationLcmPostRequestZoneIdPattern)
	}
	if err := s.AppInstanceInfo.Validate(); err != nil {
		return err
	}
	return nil
}
...
func NewFederationContextIdApplicationLcmPostRequest(federationContextId string, appId string, appInstanceId string, zoneId string, appInstanceInfo FederationContextIdApplicationLcmPostRequestAppInstanceInfo) *FederationContextIdApplicationLcmPostRequest {
...
func (o *FederationContextIdApplicationLcmPostRequest) GetFederationContextId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *FederationContextIdApplicationLcmPostRequest) GetFederationContextIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FederationContextIdApplicationLcmPostRequest) SetFederationContextId(v string) {
...
func (o *FederationContextIdApplicationLcmPostRequest) GetAppInstanceId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FederationContextIdApplicationLcmPostRequest) GetAppInstanceIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FederationContextIdApplicationLcmPostRequest) SetAppInstanceId(v string) {
	o.AppInstanceId = v
}
