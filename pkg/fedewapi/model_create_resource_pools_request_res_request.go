...
func NewCreateResourcePoolsRequestResRequest(flavours []CreateResourcePoolsRequestResRequestFlavoursInner, reserveDuration ResourceReservationDuration) *CreateResourcePoolsRequestResRequest {
