...
type ClientLocationRadLocationInner struct {
	...
	// Mobile country code of the network as broadcasted in the serving cell
	Mcc int32 `json:"mcc"`
	// Mobile network code of the network as broadcasted in the serving cell
	Mnc int32 `json:"mnc"`
	// it could be a CGI (if carrier is LTE) or NCGI (if carrier is 5G).
	CellId int32 `json:"cellId"`
	// Routing area code or Traffic area code where client is being served.
	AreaCode *int32 `json:"areaCode,omitempty"`
}

func (s *ClientLocationRadLocationInner) Validate() error {
	if s.Carrier == "" {
...
// NewClientLocationRadLocationInner instantiates a new ClientLocationRadLocationInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewClientLocationRadLocationInner(carrier string, mcc int32, mnc int32, cellId int32) *ClientLocationRadLocationInner {
	this := ClientLocationRadLocationInner{}
...
// NewClientLocationRadLocationInnerWithDefaults instantiates a new ClientLocationRadLocationInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewClientLocationRadLocationInnerWithDefaults() *ClientLocationRadLocationInner {
	this := ClientLocationRadLocationInner{}
	return &this
}

// GetCarrier returns the Carrier field value
func (o *ClientLocationRadLocationInner) GetCarrier() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ClientLocationRadLocationInner) GetCarrierOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ClientLocationRadLocationInner) SetCarrier(v string) {
	o.Carrier = v
}

// GetMcc returns the Mcc field value
func (o *ClientLocationRadLocationInner) GetMcc() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ClientLocationRadLocationInner) GetMccOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Mcc, true
...
func (o *ClientLocationRadLocationInner) SetMcc(v int32) {
	o.Mcc = v
}

// GetMnc returns the Mnc field value
func (o *ClientLocationRadLocationInner) GetMnc() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ClientLocationRadLocationInner) GetMncOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Mnc, true
...
func (o *ClientLocationRadLocationInner) SetMnc(v int32) {
	o.Mnc = v
}

// GetCellId returns the CellId field value
func (o *ClientLocationRadLocationInner) GetCellId() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ClientLocationRadLocationInner) GetCellIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ClientLocationRadLocationInner) SetCellId(v int32) {
	o.CellId = v
}
...
// SetAreaCode gets a reference to the given int32 and assigns it to the AreaCode field.
func (o *ClientLocationRadLocationInner) SetAreaCode(v int32) {
	o.AreaCode = &v
}
...
type NullableClientLocationRadLocationInner struct {
	value *ClientLocationRadLocationInner
	isSet bool
}

func (v NullableClientLocationRadLocationInner) Get() *ClientLocationRadLocationInner {
	return v.value
}

func (v *NullableClientLocationRadLocationInner) Set(val *ClientLocationRadLocationInner) {
	v.value = val
	v.isSet = true
}

func (v NullableClientLocationRadLocationInner) IsSet() bool {
	return v.isSet
}

func (v *NullableClientLocationRadLocationInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClientLocationRadLocationInner(val *ClientLocationRadLocationInner) *NullableClientLocationRadLocationInner {
	return &NullableClientLocationRadLocationInner{value: val, isSet: true}
}

func (v NullableClientLocationRadLocationInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClientLocationRadLocationInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
