...
func (s *DiscoveredEdgeNodesInner) Validate() error {
	...
	if !DiscoveredEdgeNodesInnerZoneIdRE.MatchString(s.ZoneId) {
		return errors.New("zoneId " + s.ZoneId + " does not match format " + DiscoveredEdgeNodesInnerZoneIdPattern)
	}
	if err := s.LatencyServiceEndPoints.Validate(); err != nil {
		return err
	}
	return nil
}

// NewDiscoveredEdgeNodesInner instantiates a new DiscoveredEdgeNodesInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDiscoveredEdgeNodesInner(zoneId string, latencyServiceEndPoints ServiceEndpoint) *DiscoveredEdgeNodesInner {
	this := DiscoveredEdgeNodesInner{}
	this.ZoneId = zoneId
	this.LatencyServiceEndPoints = latencyServiceEndPoints
	return &this
}

// NewDiscoveredEdgeNodesInnerWithDefaults instantiates a new DiscoveredEdgeNodesInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDiscoveredEdgeNodesInnerWithDefaults() *DiscoveredEdgeNodesInner {
	this := DiscoveredEdgeNodesInner{}
	return &this
}

// GetZoneId returns the ZoneId field value
func (o *DiscoveredEdgeNodesInner) GetZoneId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *DiscoveredEdgeNodesInner) GetZoneIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DiscoveredEdgeNodesInner) SetZoneId(v string) {
	o.ZoneId = v
}

// GetLatencyServiceEndPoints returns the LatencyServiceEndPoints field value
func (o *DiscoveredEdgeNodesInner) GetLatencyServiceEndPoints() ServiceEndpoint {
	if o == nil {
		var ret ServiceEndpoint
		return ret
	}

	return o.LatencyServiceEndPoints
}

// GetLatencyServiceEndPointsOk returns a tuple with the LatencyServiceEndPoints field value
// and a boolean to check if the value has been set.
func (o *DiscoveredEdgeNodesInner) GetLatencyServiceEndPointsOk() (*ServiceEndpoint, bool) {
	if o == nil {
		return nil, false
	}
	return &o.LatencyServiceEndPoints, true
}

// SetLatencyServiceEndPoints sets field value
func (o *DiscoveredEdgeNodesInner) SetLatencyServiceEndPoints(v ServiceEndpoint) {
	o.LatencyServiceEndPoints = v
}
...
type NullableDiscoveredEdgeNodesInner struct {
	value *DiscoveredEdgeNodesInner
	isSet bool
}

func (v NullableDiscoveredEdgeNodesInner) Get() *DiscoveredEdgeNodesInner {
	return v.value
}

func (v *NullableDiscoveredEdgeNodesInner) Set(val *DiscoveredEdgeNodesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscoveredEdgeNodesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscoveredEdgeNodesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscoveredEdgeNodesInner(val *DiscoveredEdgeNodesInner) *NullableDiscoveredEdgeNodesInner {
	return &NullableDiscoveredEdgeNodesInner{value: val, isSet: true}
}

func (v NullableDiscoveredEdgeNodesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscoveredEdgeNodesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
