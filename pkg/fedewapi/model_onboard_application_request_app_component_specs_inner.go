...
// NewOnboardApplicationRequestAppComponentSpecsInner instantiates a new OnboardApplicationRequestAppComponentSpecsInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewOnboardApplicationRequestAppComponentSpecsInner(serviceNameNB string, artefactId string) *OnboardApplicationRequestAppComponentSpecsInner {
	this := OnboardApplicationRequestAppComponentSpecsInner{}
	this.ServiceNameNB = serviceNameNB
	this.ArtefactId = artefactId
	return &this
}

// NewOnboardApplicationRequestAppComponentSpecsInnerWithDefaults instantiates a new OnboardApplicationRequestAppComponentSpecsInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewOnboardApplicationRequestAppComponentSpecsInnerWithDefaults() *OnboardApplicationRequestAppComponentSpecsInner {
	this := OnboardApplicationRequestAppComponentSpecsInner{}
	return &this
}

// GetServiceNameNB returns the ServiceNameNB field value
func (o *OnboardApplicationRequestAppComponentSpecsInner) GetServiceNameNB() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *OnboardApplicationRequestAppComponentSpecsInner) GetServiceNameNBOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnboardApplicationRequestAppComponentSpecsInner) SetServiceNameNB(v string) {
	o.ServiceNameNB = v
}
...
func (o *OnboardApplicationRequestAppComponentSpecsInner) SetServiceNameEW(v string) {
	o.ServiceNameEW = &v
}
...
func (o *OnboardApplicationRequestAppComponentSpecsInner) SetComponentName(v string) {
	o.ComponentName = &v
}

// GetArtefactId returns the ArtefactId field value
func (o *OnboardApplicationRequestAppComponentSpecsInner) GetArtefactId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OnboardApplicationRequestAppComponentSpecsInner) GetArtefactIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OnboardApplicationRequestAppComponentSpecsInner) SetArtefactId(v string) {
	o.ArtefactId = v
}
...
type NullableOnboardApplicationRequestAppComponentSpecsInner struct {
	value *OnboardApplicationRequestAppComponentSpecsInner
	isSet bool
}

func (v NullableOnboardApplicationRequestAppComponentSpecsInner) Get() *OnboardApplicationRequestAppComponentSpecsInner {
	return v.value
}

func (v *NullableOnboardApplicationRequestAppComponentSpecsInner) Set(val *OnboardApplicationRequestAppComponentSpecsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOnboardApplicationRequestAppComponentSpecsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOnboardApplicationRequestAppComponentSpecsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOnboardApplicationRequestAppComponentSpecsInner(val *OnboardApplicationRequestAppComponentSpecsInner) *NullableOnboardApplicationRequestAppComponentSpecsInner {
	return &NullableOnboardApplicationRequestAppComponentSpecsInner{value: val, isSet: true}
}

func (v NullableOnboardApplicationRequestAppComponentSpecsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOnboardApplicationRequestAppComponentSpecsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
