...
var MobileNetworkIdsMccPattern = strings.TrimPrefix(strings.TrimSuffix("/^\\d{3}$/", "/"), "/")
var MobileNetworkIdsMccRE = regexp.MustCompile(MobileNetworkIdsMccPattern)
var MobileNetworkIdsMncsPattern = strings.TrimPrefix(strings.TrimSuffix("", "/"), "/")
var MobileNetworkIdsMncsRE = regexp.MustCompile(MobileNetworkIdsMncsPattern)

func (s *MobileNetworkIds) Validate() error {
	if s.Mcc != nil && !MobileNetworkIdsMccRE.MatchString(*s.Mcc) {
		return errors.New("mcc " + *s.Mcc + " does not match format " + MobileNetworkIdsMccPattern)
	}
	for ii := range s.Mncs {
		if !MobileNetworkIdsMncsRE.MatchString(s.Mncs[ii]) {
			return errors.New("Mncs " + s.Mncs[ii] + " does not match format " + MobileNetworkIdsMncsPattern)
		}
	}
	return nil
}

// NewMobileNetworkIds instantiates a new MobileNetworkIds object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMobileNetworkIds() *MobileNetworkIds {
	this := MobileNetworkIds{}
	return &this
}

// NewMobileNetworkIdsWithDefaults instantiates a new MobileNetworkIds object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMobileNetworkIdsWithDefaults() *MobileNetworkIds {
	this := MobileNetworkIds{}
	return &this
}
...
func (o *MobileNetworkIds) SetMcc(v string) {
	o.Mcc = &v
}
...
func (o *MobileNetworkIds) SetMncs(v []string) {
	o.Mncs = v
}
...
type NullableMobileNetworkIds struct {
	value *MobileNetworkIds
	isSet bool
}

func (v NullableMobileNetworkIds) Get() *MobileNetworkIds {
	return v.value
}

func (v *NullableMobileNetworkIds) Set(val *MobileNetworkIds) {
	v.value = val
	v.isSet = true
}

func (v NullableMobileNetworkIds) IsSet() bool {
	return v.isSet
}

func (v *NullableMobileNetworkIds) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMobileNetworkIds(val *MobileNetworkIds) *NullableMobileNetworkIds {
	return &NullableMobileNetworkIds{value: val, isSet: true}
}

func (v NullableMobileNetworkIds) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMobileNetworkIds) UnmarshalJSON(src []byte) error {
	v.isSet = true
