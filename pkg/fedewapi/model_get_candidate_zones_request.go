...
func (s *GetCandidateZonesRequest) Validate() error {
	...
	if !GetCandidateZonesRequestAppProviderIdRE.MatchString(s.AppProviderId) {
		return errors.New("appProviderId " + s.AppProviderId + " does not match format " + GetCandidateZonesRequestAppProviderIdPattern)
	}
	if s.AppId == "" {
		return errors.New("appId is required")
	}
	if !GetCandidateZonesRequestAppIdRE.MatchString(s.AppId) {
		return errors.New("appId " + s.AppId + " does not match format " + GetCandidateZonesRequestAppIdPattern)
	}
	if s.EdgeDiscoveryFilters != nil {
		if err := s.EdgeDiscoveryFilters.Validate(); err != nil {
			return err
		}
	}
	return nil
...
// NewGetCandidateZonesRequest instantiates a new GetCandidateZonesRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetCandidateZonesRequest(appProviderId string, appId string) *GetCandidateZonesRequest {
	this := GetCandidateZonesRequest{}
	this.AppProviderId = appProviderId
	this.AppId = appId
	return &this
}

// NewGetCandidateZonesRequestWithDefaults instantiates a new GetCandidateZonesRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetCandidateZonesRequestWithDefaults() *GetCandidateZonesRequest {
	this := GetCandidateZonesRequest{}
	return &this
}

// GetAppProviderId returns the AppProviderId field value
func (o *GetCandidateZonesRequest) GetAppProviderId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *GetCandidateZonesRequest) GetAppProviderIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetCandidateZonesRequest) SetAppProviderId(v string) {
	o.AppProviderId = v
}

// GetAppId returns the AppId field value
func (o *GetCandidateZonesRequest) GetAppId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetCandidateZonesRequest) GetAppIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.AppId, true
...
func (o *GetCandidateZonesRequest) SetAppId(v string) {
	o.AppId = v
}
...
// SetEdgeDiscoveryFilters gets a reference to the given GetCandidateZonesRequestEdgeDiscoveryFilters and assigns it to the EdgeDiscoveryFilters field.
func (o *GetCandidateZonesRequest) SetEdgeDiscoveryFilters(v GetCandidateZonesRequestEdgeDiscoveryFilters) {
	o.EdgeDiscoveryFilters = &v
}
...
type NullableGetCandidateZonesRequest struct {
	value *GetCandidateZonesRequest
	isSet bool
}

func (v NullableGetCandidateZonesRequest) Get() *GetCandidateZonesRequest {
	return v.value
}

func (v *NullableGetCandidateZonesRequest) Set(val *GetCandidateZonesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCandidateZonesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCandidateZonesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCandidateZonesRequest(val *GetCandidateZonesRequest) *NullableGetCandidateZonesRequest {
	return &NullableGetCandidateZonesRequest{value: val, isSet: true}
}

func (v NullableGetCandidateZonesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCandidateZonesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
