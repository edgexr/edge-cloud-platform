...
// checks if the CallbackCredentials type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallbackCredentials{}
...
func (s *CallbackCredentials) Validate() error {
	if s.TokenUrl == "" {
...
// NewCallbackCredentials instantiates a new CallbackCredentials object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCallbackCredentials(tokenUrl string, clientId string, clientSecret string) *CallbackCredentials {
...
// NewCallbackCredentialsWithDefaults instantiates a new CallbackCredentials object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCallbackCredentialsWithDefaults() *CallbackCredentials {
	this := CallbackCredentials{}
	return &this
}

// GetTokenUrl returns the TokenUrl field value
func (o *CallbackCredentials) GetTokenUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CallbackCredentials) GetTokenUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CallbackCredentials) SetTokenUrl(v string) {
	o.TokenUrl = v
}

// GetClientId returns the ClientId field value
func (o *CallbackCredentials) GetClientId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CallbackCredentials) GetClientIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CallbackCredentials) SetClientId(v string) {
	o.ClientId = v
}

// GetClientSecret returns the ClientSecret field value
func (o *CallbackCredentials) GetClientSecret() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CallbackCredentials) GetClientSecretOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CallbackCredentials) SetClientSecret(v string) {
	o.ClientSecret = v
}

func (o CallbackCredentials) MarshalJSON() ([]byte, error) {
...
func (o CallbackCredentials) ToMap() (map[string]interface{}, error) {
...
type NullableCallbackCredentials struct {
	value *CallbackCredentials
	isSet bool
}

func (v NullableCallbackCredentials) Get() *CallbackCredentials {
	return v.value
}

func (v *NullableCallbackCredentials) Set(val *CallbackCredentials) {
	v.value = val
	v.isSet = true
}

func (v NullableCallbackCredentials) IsSet() bool {
	return v.isSet
}

func (v *NullableCallbackCredentials) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallbackCredentials(val *CallbackCredentials) *NullableCallbackCredentials {
	return &NullableCallbackCredentials{value: val, isSet: true}
}

func (v NullableCallbackCredentials) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallbackCredentials) UnmarshalJSON(src []byte) error {
	v.isSet = true
