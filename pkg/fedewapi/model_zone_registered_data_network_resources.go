...
func (s *ZoneRegisteredDataNetworkResources) Validate() error {
	return nil
}

// NewZoneRegisteredDataNetworkResources instantiates a new ZoneRegisteredDataNetworkResources object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewZoneRegisteredDataNetworkResources(egressBandWidth int32, dedicatedNIC int32, supportSriov bool, supportDPDK bool) *ZoneRegisteredDataNetworkResources {
	this := ZoneRegisteredDataNetworkResources{}
...
// NewZoneRegisteredDataNetworkResourcesWithDefaults instantiates a new ZoneRegisteredDataNetworkResources object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewZoneRegisteredDataNetworkResourcesWithDefaults() *ZoneRegisteredDataNetworkResources {
	this := ZoneRegisteredDataNetworkResources{}
	return &this
}

// GetEgressBandWidth returns the EgressBandWidth field value
func (o *ZoneRegisteredDataNetworkResources) GetEgressBandWidth() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *ZoneRegisteredDataNetworkResources) GetEgressBandWidthOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ZoneRegisteredDataNetworkResources) SetEgressBandWidth(v int32) {
	o.EgressBandWidth = v
}

// GetDedicatedNIC returns the DedicatedNIC field value
func (o *ZoneRegisteredDataNetworkResources) GetDedicatedNIC() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ZoneRegisteredDataNetworkResources) GetDedicatedNICOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ZoneRegisteredDataNetworkResources) SetDedicatedNIC(v int32) {
	o.DedicatedNIC = v
}

// GetSupportSriov returns the SupportSriov field value
func (o *ZoneRegisteredDataNetworkResources) GetSupportSriov() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ZoneRegisteredDataNetworkResources) GetSupportSriovOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ZoneRegisteredDataNetworkResources) SetSupportSriov(v bool) {
	o.SupportSriov = v
}

// GetSupportDPDK returns the SupportDPDK field value
func (o *ZoneRegisteredDataNetworkResources) GetSupportDPDK() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ZoneRegisteredDataNetworkResources) GetSupportDPDKOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ZoneRegisteredDataNetworkResources) SetSupportDPDK(v bool) {
	o.SupportDPDK = v
}
...
type NullableZoneRegisteredDataNetworkResources struct {
	value *ZoneRegisteredDataNetworkResources
	isSet bool
}

func (v NullableZoneRegisteredDataNetworkResources) Get() *ZoneRegisteredDataNetworkResources {
	return v.value
}

func (v *NullableZoneRegisteredDataNetworkResources) Set(val *ZoneRegisteredDataNetworkResources) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneRegisteredDataNetworkResources) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneRegisteredDataNetworkResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneRegisteredDataNetworkResources(val *ZoneRegisteredDataNetworkResources) *NullableZoneRegisteredDataNetworkResources {
	return &NullableZoneRegisteredDataNetworkResources{value: val, isSet: true}
}

func (v NullableZoneRegisteredDataNetworkResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneRegisteredDataNetworkResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
