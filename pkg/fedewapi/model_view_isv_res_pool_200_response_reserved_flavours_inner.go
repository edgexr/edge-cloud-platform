...
// NewViewISVResPool200ResponseReservedFlavoursInner instantiates a new ViewISVResPool200ResponseReservedFlavoursInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewViewISVResPool200ResponseReservedFlavoursInner(flavourId Flavour, count int32) *ViewISVResPool200ResponseReservedFlavoursInner {
	this := ViewISVResPool200ResponseReservedFlavoursInner{}
	this.FlavourId = flavourId
	this.Count = count
	return &this
}

// NewViewISVResPool200ResponseReservedFlavoursInnerWithDefaults instantiates a new ViewISVResPool200ResponseReservedFlavoursInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewViewISVResPool200ResponseReservedFlavoursInnerWithDefaults() *ViewISVResPool200ResponseReservedFlavoursInner {
	this := ViewISVResPool200ResponseReservedFlavoursInner{}
	return &this
}

// GetFlavourId returns the FlavourId field value
func (o *ViewISVResPool200ResponseReservedFlavoursInner) GetFlavourId() Flavour {
	if o == nil {
		var ret Flavour
		return ret
	}
...
func (o *ViewISVResPool200ResponseReservedFlavoursInner) GetFlavourIdOk() (*Flavour, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ViewISVResPool200ResponseReservedFlavoursInner) SetFlavourId(v Flavour) {
	o.FlavourId = v
}

// GetCount returns the Count field value
func (o *ViewISVResPool200ResponseReservedFlavoursInner) GetCount() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ViewISVResPool200ResponseReservedFlavoursInner) GetCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Count, true
...
func (o *ViewISVResPool200ResponseReservedFlavoursInner) SetCount(v int32) {
	o.Count = v
}
...
type NullableViewISVResPool200ResponseReservedFlavoursInner struct {
	value *ViewISVResPool200ResponseReservedFlavoursInner
	isSet bool
}

func (v NullableViewISVResPool200ResponseReservedFlavoursInner) Get() *ViewISVResPool200ResponseReservedFlavoursInner {
	return v.value
}

func (v *NullableViewISVResPool200ResponseReservedFlavoursInner) Set(val *ViewISVResPool200ResponseReservedFlavoursInner) {
	v.value = val
	v.isSet = true
}

func (v NullableViewISVResPool200ResponseReservedFlavoursInner) IsSet() bool {
	return v.isSet
}

func (v *NullableViewISVResPool200ResponseReservedFlavoursInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewISVResPool200ResponseReservedFlavoursInner(val *ViewISVResPool200ResponseReservedFlavoursInner) *NullableViewISVResPool200ResponseReservedFlavoursInner {
	return &NullableViewISVResPool200ResponseReservedFlavoursInner{value: val, isSet: true}
}

func (v NullableViewISVResPool200ResponseReservedFlavoursInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewISVResPool200ResponseReservedFlavoursInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
