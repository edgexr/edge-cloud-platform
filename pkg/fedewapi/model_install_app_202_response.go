...
// NewInstallApp202Response instantiates a new InstallApp202Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInstallApp202Response(zoneId string, appInstIdentifier string) *InstallApp202Response {
	this := InstallApp202Response{}
	this.ZoneId = zoneId
	this.AppInstIdentifier = appInstIdentifier
	return &this
}

// NewInstallApp202ResponseWithDefaults instantiates a new InstallApp202Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInstallApp202ResponseWithDefaults() *InstallApp202Response {
	this := InstallApp202Response{}
	return &this
}

// GetZoneId returns the ZoneId field value
func (o *InstallApp202Response) GetZoneId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InstallApp202Response) GetZoneIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InstallApp202Response) SetZoneId(v string) {
	o.ZoneId = v
}

// GetAppInstIdentifier returns the AppInstIdentifier field value
func (o *InstallApp202Response) GetAppInstIdentifier() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InstallApp202Response) GetAppInstIdentifierOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InstallApp202Response) SetAppInstIdentifier(v string) {
...
type NullableInstallApp202Response struct {
	value *InstallApp202Response
	isSet bool
}

func (v NullableInstallApp202Response) Get() *InstallApp202Response {
	return v.value
}

func (v *NullableInstallApp202Response) Set(val *InstallApp202Response) {
	v.value = val
	v.isSet = true
}

func (v NullableInstallApp202Response) IsSet() bool {
	return v.isSet
}

func (v *NullableInstallApp202Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstallApp202Response(val *InstallApp202Response) *NullableInstallApp202Response {
	return &NullableInstallApp202Response{value: val, isSet: true}
}

func (v NullableInstallApp202Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstallApp202Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
