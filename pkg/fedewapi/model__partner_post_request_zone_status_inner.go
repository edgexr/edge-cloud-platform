...
func (s *PartnerPostRequestZoneStatusInner) Validate() error {
	...
	if !PartnerPostRequestZoneStatusInnerZoneIdRE.MatchString(s.ZoneId) {
		return errors.New("zoneId " + s.ZoneId + " does not match format " + PartnerPostRequestZoneStatusInnerZoneIdPattern)
	}
	return nil
}

// NewPartnerPostRequestZoneStatusInner instantiates a new PartnerPostRequestZoneStatusInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPartnerPostRequestZoneStatusInner(zoneId string, status Status) *PartnerPostRequestZoneStatusInner {
	this := PartnerPostRequestZoneStatusInner{}
	this.ZoneId = zoneId
	this.Status = status
	return &this
}

// NewPartnerPostRequestZoneStatusInnerWithDefaults instantiates a new PartnerPostRequestZoneStatusInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPartnerPostRequestZoneStatusInnerWithDefaults() *PartnerPostRequestZoneStatusInner {
	this := PartnerPostRequestZoneStatusInner{}
	return &this
}

// GetZoneId returns the ZoneId field value
func (o *PartnerPostRequestZoneStatusInner) GetZoneId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *PartnerPostRequestZoneStatusInner) GetZoneIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PartnerPostRequestZoneStatusInner) SetZoneId(v string) {
	o.ZoneId = v
}

// GetStatus returns the Status field value
func (o *PartnerPostRequestZoneStatusInner) GetStatus() Status {
	if o == nil {
		var ret Status
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PartnerPostRequestZoneStatusInner) GetStatusOk() (*Status, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PartnerPostRequestZoneStatusInner) SetStatus(v Status) {
	o.Status = v
}
...
type NullablePartnerPostRequestZoneStatusInner struct {
	value *PartnerPostRequestZoneStatusInner
	isSet bool
}

func (v NullablePartnerPostRequestZoneStatusInner) Get() *PartnerPostRequestZoneStatusInner {
	return v.value
}

func (v *NullablePartnerPostRequestZoneStatusInner) Set(val *PartnerPostRequestZoneStatusInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerPostRequestZoneStatusInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerPostRequestZoneStatusInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerPostRequestZoneStatusInner(val *PartnerPostRequestZoneStatusInner) *NullablePartnerPostRequestZoneStatusInner {
	return &NullablePartnerPostRequestZoneStatusInner{value: val, isSet: true}
}

func (v NullablePartnerPostRequestZoneStatusInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerPostRequestZoneStatusInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
