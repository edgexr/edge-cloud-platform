...
// GetZoneData200Response struct for GetZoneData200Response
type GetZoneData200Response struct {
	...
	NetworkResources *GetZoneData200ResponseNetworkResources `json:"networkResources,omitempty"`
}

// NewGetZoneData200Response instantiates a new GetZoneData200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetZoneData200Response(zoneId string, flavoursSupported []Flavour) *GetZoneData200Response {
	this := GetZoneData200Response{}
	this.ZoneId = zoneId
	this.FlavoursSupported = flavoursSupported
	return &this
}

// NewGetZoneData200ResponseWithDefaults instantiates a new GetZoneData200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetZoneData200ResponseWithDefaults() *GetZoneData200Response {
	this := GetZoneData200Response{}
	return &this
}

// GetZoneId returns the ZoneId field value
func (o *GetZoneData200Response) GetZoneId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *GetZoneData200Response) GetZoneIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetZoneData200Response) SetZoneId(v string) {
	o.ZoneId = v
}

// GetReservedComputeResources returns the ReservedComputeResources field value if set, zero value otherwise.
func (o *GetZoneData200Response) GetReservedComputeResources() []ComputeResourceInfo {
...
// and a boolean to check if the value has been set.
func (o *GetZoneData200Response) GetReservedComputeResourcesOk() ([]ComputeResourceInfo, bool) {
	if o == nil || o.ReservedComputeResources == nil {
		return nil, false
	}
...
func (o *GetZoneData200Response) HasReservedComputeResources() bool {
	if o != nil && o.ReservedComputeResources != nil {
		return true
	}
...
func (o *GetZoneData200Response) SetReservedComputeResources(v []ComputeResourceInfo) {
...
func (o *GetZoneData200Response) GetComputeResourceQuotaLimits() []ComputeResourceInfo {
...
// and a boolean to check if the value has been set.
func (o *GetZoneData200Response) GetComputeResourceQuotaLimitsOk() ([]ComputeResourceInfo, bool) {
	if o == nil || o.ComputeResourceQuotaLimits == nil {
		return nil, false
	}
...
func (o *GetZoneData200Response) HasComputeResourceQuotaLimits() bool {
	if o != nil && o.ComputeResourceQuotaLimits != nil {
		return true
	}
...
func (o *GetZoneData200Response) SetComputeResourceQuotaLimits(v []ComputeResourceInfo) {
	o.ComputeResourceQuotaLimits = v
}

// GetFlavoursSupported returns the FlavoursSupported field value
func (o *GetZoneData200Response) GetFlavoursSupported() []Flavour {
	if o == nil {
		var ret []Flavour
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetZoneData200Response) GetFlavoursSupportedOk() ([]Flavour, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetZoneData200Response) SetFlavoursSupported(v []Flavour) {
	o.FlavoursSupported = v
}

// GetNetworkResources returns the NetworkResources field value if set, zero value otherwise.
func (o *GetZoneData200Response) GetNetworkResources() GetZoneData200ResponseNetworkResources {
	if o == nil || o.NetworkResources == nil {
		var ret GetZoneData200ResponseNetworkResources
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetZoneData200Response) GetNetworkResourcesOk() (*GetZoneData200ResponseNetworkResources, bool) {
	if o == nil || o.NetworkResources == nil {
		return nil, false
	}
...
func (o *GetZoneData200Response) HasNetworkResources() bool {
	if o != nil && o.NetworkResources != nil {
		return true
	}
...
// SetNetworkResources gets a reference to the given GetZoneData200ResponseNetworkResources and assigns it to the NetworkResources field.
func (o *GetZoneData200Response) SetNetworkResources(v GetZoneData200ResponseNetworkResources) {
	o.NetworkResources = &v
}

func (o GetZoneData200Response) MarshalJSON() ([]byte, error) {
...
type NullableGetZoneData200Response struct {
	value *GetZoneData200Response
	isSet bool
}

func (v NullableGetZoneData200Response) Get() *GetZoneData200Response {
	return v.value
}

func (v *NullableGetZoneData200Response) Set(val *GetZoneData200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZoneData200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZoneData200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZoneData200Response(val *GetZoneData200Response) *NullableGetZoneData200Response {
	return &NullableGetZoneData200Response{value: val, isSet: true}
}

func (v NullableGetZoneData200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZoneData200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
