...
func (s *UpdateApplicationRequest) Validate() error {
	if s.AppUpdQoSProfile != nil {
		if err := s.AppUpdQoSProfile.Validate(); err != nil {
			return err
		}
	}
...
// SetAppUpdQoSProfile gets a reference to the given UpdateApplicationRequestAppUpdQoSProfile and assigns it to the AppUpdQoSProfile field.
func (o *UpdateApplicationRequest) SetAppUpdQoSProfile(v UpdateApplicationRequestAppUpdQoSProfile) {
	o.AppUpdQoSProfile = &v
}
...
// SetAppComponentSpecs gets a reference to the given []UpdateApplicationRequestAppComponentSpecsInner and assigns it to the AppComponentSpecs field.
func (o *UpdateApplicationRequest) SetAppComponentSpecs(v []UpdateApplicationRequestAppComponentSpecsInner) {
