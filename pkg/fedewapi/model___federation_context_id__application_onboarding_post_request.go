...
func (s *FederationContextIdApplicationOnboardingPostRequest) Validate() error {
	...
	if !FederationContextIdApplicationOnboardingPostRequestFederationContextIdRE.MatchString(s.FederationContextId) {
		return errors.New("federationContextId " + s.FederationContextId + " does not match format " + FederationContextIdApplicationOnboardingPostRequestFederationContextIdPattern)
	}
	if s.AppId == "" {
		return errors.New("appId is required")
	}
	if !FederationContextIdApplicationOnboardingPostRequestAppIdRE.MatchString(s.AppId) {
		return errors.New("appId " + s.AppId + " does not match format " + FederationContextIdApplicationOnboardingPostRequestAppIdPattern)
	}
	for ii := range s.StatusInfo {
		if err := s.StatusInfo[ii].Validate(); err != nil {
			return err
		}
	}
	return nil
...
// NewFederationContextIdApplicationOnboardingPostRequest instantiates a new FederationContextIdApplicationOnboardingPostRequest object
...
// NewFederationContextIdApplicationOnboardingPostRequestWithDefaults instantiates a new FederationContextIdApplicationOnboardingPostRequest object
...
func (o *FederationContextIdApplicationOnboardingPostRequest) GetStatusInfo() []FederationContextIdApplicationOnboardingPostRequestStatusInfoInner {
	if o == nil {
		var ret []FederationContextIdApplicationOnboardingPostRequestStatusInfoInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FederationContextIdApplicationOnboardingPostRequest) GetStatusInfoOk() ([]FederationContextIdApplicationOnboardingPostRequestStatusInfoInner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FederationContextIdApplicationOnboardingPostRequest) SetStatusInfo(v []FederationContextIdApplicationOnboardingPostRequestStatusInfoInner) {
	o.StatusInfo = v
}
...
type NullableFederationContextIdApplicationOnboardingPostRequest struct {
	value *FederationContextIdApplicationOnboardingPostRequest
	isSet bool
}

func (v NullableFederationContextIdApplicationOnboardingPostRequest) Get() *FederationContextIdApplicationOnboardingPostRequest {
	return v.value
}

func (v *NullableFederationContextIdApplicationOnboardingPostRequest) Set(val *FederationContextIdApplicationOnboardingPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableFederationContextIdApplicationOnboardingPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableFederationContextIdApplicationOnboardingPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFederationContextIdApplicationOnboardingPostRequest(val *FederationContextIdApplicationOnboardingPostRequest) *NullableFederationContextIdApplicationOnboardingPostRequest {
	return &NullableFederationContextIdApplicationOnboardingPostRequest{value: val, isSet: true}
}

func (v NullableFederationContextIdApplicationOnboardingPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFederationContextIdApplicationOnboardingPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
