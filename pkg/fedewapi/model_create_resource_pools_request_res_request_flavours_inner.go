...
func (s *CreateResourcePoolsRequestResRequestFlavoursInner) Validate() error {
	if s.FlavourId == "" {
...
// NewCreateResourcePoolsRequestResRequestFlavoursInner instantiates a new CreateResourcePoolsRequestResRequestFlavoursInner object
...
// NewCreateResourcePoolsRequestResRequestFlavoursInnerWithDefaults instantiates a new CreateResourcePoolsRequestResRequestFlavoursInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCreateResourcePoolsRequestResRequestFlavoursInnerWithDefaults() *CreateResourcePoolsRequestResRequestFlavoursInner {
	this := CreateResourcePoolsRequestResRequestFlavoursInner{}
	return &this
}
...
func (o *CreateResourcePoolsRequestResRequestFlavoursInner) GetNumFlavour() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateResourcePoolsRequestResRequestFlavoursInner) GetNumFlavourOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateResourcePoolsRequestResRequestFlavoursInner) SetNumFlavour(v int32) {
	o.NumFlavour = v
}
...
// SetMinNumOfFlavours gets a reference to the given int32 and assigns it to the MinNumOfFlavours field.
func (o *CreateResourcePoolsRequestResRequestFlavoursInner) SetMinNumOfFlavours(v int32) {
	o.MinNumOfFlavours = &v
}
...
type NullableCreateResourcePoolsRequestResRequestFlavoursInner struct {
	value *CreateResourcePoolsRequestResRequestFlavoursInner
	isSet bool
}

func (v NullableCreateResourcePoolsRequestResRequestFlavoursInner) Get() *CreateResourcePoolsRequestResRequestFlavoursInner {
	return v.value
}

func (v *NullableCreateResourcePoolsRequestResRequestFlavoursInner) Set(val *CreateResourcePoolsRequestResRequestFlavoursInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateResourcePoolsRequestResRequestFlavoursInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateResourcePoolsRequestResRequestFlavoursInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateResourcePoolsRequestResRequestFlavoursInner(val *CreateResourcePoolsRequestResRequestFlavoursInner) *NullableCreateResourcePoolsRequestResRequestFlavoursInner {
	return &NullableCreateResourcePoolsRequestResRequestFlavoursInner{value: val, isSet: true}
}

func (v NullableCreateResourcePoolsRequestResRequestFlavoursInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateResourcePoolsRequestResRequestFlavoursInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
