...
// ZoneRegisterationRequestData struct for ZoneRegisterationRequestData
type ZoneRegisterationRequestData struct {
	AcceptedAvailabilityZones []string `json:"acceptedAvailabilityZones"`
	AvailZoneNotifLink string `json:"availZoneNotifLink"`
}

// NewZoneRegisterationRequestData instantiates a new ZoneRegisterationRequestData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewZoneRegisterationRequestData(acceptedAvailabilityZones []string, availZoneNotifLink string) *ZoneRegisterationRequestData {
	this := ZoneRegisterationRequestData{}
	this.AcceptedAvailabilityZones = acceptedAvailabilityZones
	this.AvailZoneNotifLink = availZoneNotifLink
	return &this
}

// NewZoneRegisterationRequestDataWithDefaults instantiates a new ZoneRegisterationRequestData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewZoneRegisterationRequestDataWithDefaults() *ZoneRegisterationRequestData {
	this := ZoneRegisterationRequestData{}
	return &this
}

// GetAcceptedAvailabilityZones returns the AcceptedAvailabilityZones field value
func (o *ZoneRegisterationRequestData) GetAcceptedAvailabilityZones() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *ZoneRegisterationRequestData) GetAcceptedAvailabilityZonesOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ZoneRegisterationRequestData) SetAcceptedAvailabilityZones(v []string) {
	o.AcceptedAvailabilityZones = v
}

// GetAvailZoneNotifLink returns the AvailZoneNotifLink field value
func (o *ZoneRegisterationRequestData) GetAvailZoneNotifLink() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ZoneRegisterationRequestData) GetAvailZoneNotifLinkOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ZoneRegisterationRequestData) SetAvailZoneNotifLink(v string) {
	o.AvailZoneNotifLink = v
}

func (o ZoneRegisterationRequestData) MarshalJSON() ([]byte, error) {
...
type NullableZoneRegisterationRequestData struct {
	value *ZoneRegisterationRequestData
	isSet bool
}

func (v NullableZoneRegisterationRequestData) Get() *ZoneRegisterationRequestData {
	return v.value
}

func (v *NullableZoneRegisterationRequestData) Set(val *ZoneRegisterationRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneRegisterationRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneRegisterationRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneRegisterationRequestData(val *ZoneRegisterationRequestData) *NullableZoneRegisterationRequestData {
	return &NullableZoneRegisterationRequestData{value: val, isSet: true}
}

func (v NullableZoneRegisterationRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneRegisterationRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
