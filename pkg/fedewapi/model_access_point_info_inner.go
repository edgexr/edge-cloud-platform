...
func (s *AccessPointInfoInner) Validate() error {
	...
	if !AccessPointInfoInnerInterfaceIdRE.MatchString(s.InterfaceId) {
		return errors.New("interfaceId " + s.InterfaceId + " does not match format " + AccessPointInfoInnerInterfaceIdPattern)
	}
