...
type ViewApplication200Response struct {
	...
	AppDeploymentZones []string      `json:"appDeploymentZones"`
...
func (s *ViewApplication200Response) Validate() error {
	if s.AppId == "" {
		return errors.New("appId is required")
	}
	if !ViewApplication200ResponseAppIdRE.MatchString(s.AppId) {
		return errors.New("appId " + s.AppId + " does not match format " + ViewApplication200ResponseAppIdPattern)
	}
	if s.AppProviderId == "" {
		return errors.New("appProviderId is required")
	}
	if !ViewApplication200ResponseAppProviderIdRE.MatchString(s.AppProviderId) {
		return errors.New("appProviderId " + s.AppProviderId + " does not match format " + ViewApplication200ResponseAppProviderIdPattern)
	}
	for ii := range s.AppDeploymentZones {
		if !ViewApplication200ResponseAppDeploymentZonesRE.MatchString(s.AppDeploymentZones[ii]) {
			return errors.New("AppDeploymentZones " + s.AppDeploymentZones[ii] + " does not match format " + ViewApplication200ResponseAppDeploymentZonesPattern)
		}
	}
...
func NewViewApplication200Response(appId string, appProviderId string, appDeploymentZones []string, appMetaData AppMetaData, appQoSProfile AppQoSProfile, appComponentSpecs []AppComponentSpecsInner) *ViewApplication200Response {
...
func (o *ViewApplication200Response) GetAppDeploymentZones() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ViewApplication200Response) GetAppDeploymentZonesOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ViewApplication200Response) SetAppDeploymentZones(v []string) {
